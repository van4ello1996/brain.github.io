...
;function hd(){this.h=[];this.i=-1}
hd.prototype.set=function(a,b){b=void 0===b?!0:b;0<=a&&52>a&&0===a%1&&this.h[a]!=b&&(this.h[a]=b,this.i=-1)};
hd.prototype.get=function(a){return!!this.h[a]};
function id(a){-1==a.i&&(a.i=Za(a.h,function(b,c,d){return c?b+Math.pow(2,d):b},0));
return a.i}
...
function E(a,b){return a in of?of[a]:b}
...
function sf(a){var b=A("yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,void 0):(b=E("ERRORS",[]),b.push([a,"ERROR",void 0,void 0,void 0]),N("ERRORS",b));qf(a)}
function tf(a){var b=A("yt.logging.errors.log");b?b(a,"WARNING",void 0,void 0,void 0):(b=E("ERRORS",[]),b.push([a,"WARNING",void 0,void 0,void 0]),N("ERRORS",b))}
;var uf=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};z("yt.msgs_",uf,void 0);function vf(a){nf(uf,arguments)}
;function O(a){a=wf(a);return"string"===typeof a&&"false"===a?!1:!!a}
function xf(a,b){a=wf(a);return void 0===a&&void 0!==b?b:Number(a||0)}
function wf(a){var b=E("EXPERIMENTS_FORCED_FLAGS",{});return void 0!==b[a]?b[a]:E("EXPERIMENT_FLAGS",{})[a]}
;var yf=0,zf=mc?"webkit":lc?"moz":jc?"ms":ic?"o":"";z("ytDomDomGetNextId",A("ytDomDomGetNextId")||function(){return++yf},void 0);var Af={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
function Bf(a){this.type="";this.state=this.source=this.data=this.currentTarget=this.relatedTarget=this.target=null;this.charCode=this.keyCode=0;this.metaKey=this.shiftKey=this.ctrlKey=this.altKey=!1;this.rotation=this.clientY=this.clientX=0;this.changedTouches=this.touches=null;try{if(a=a||window.event){this.event=a;for(var b in a)b in Af||(this[b]=a[b]);this.rotation=a.rotation;var c=a.target||a.srcElement;c&&3==c.nodeType&&(c=c.parentNode);this.target=c;var d=a.relatedTarget;if(d)try{d=d.nodeName?
...
Bf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var fb=y.ytEventsEventsListeners||{};z("ytEventsEventsListeners",fb,void 0);var Df=y.ytEventsEventsCounter||{count:0};z("ytEventsEventsCounter",Df,void 0);
...
var Ff=Va(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
window.addEventListener("test",null,b)}catch(c){}return a});
function Gf(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=Ef(a,b,c,d);if(e)return e;e=++Df.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(h){h=new Bf(h);if(!Lc(h.relatedTarget,function(k){return k==a}))return h.currentTarget=a,h.type=b,c.call(a,h)}:function(h){h=new Bf(h);
h.currentTarget=a;return c.call(a,h)};
g=rf(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Ff()||"boolean"===typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);fb[e]=[a,b,c,g,d];return e}
function Hf(a){a&&("string"==typeof a&&(a=[a]),D(a,function(b){if(b in fb){var c=fb[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?Ff()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete fb[b]}}))}
...
;function Lf(a){this.C=a;this.i=null;this.m=0;this.B=null;this.o=0;this.j=[];for(a=0;4>a;a++)this.j.push(0);this.l=0;this.J=Gf(window,"mousemove",Oa(this.K,this));a=Oa(this.F,this);"function"===typeof a&&(a=rf(a));this.L=window.setInterval(a,25)}
C(Lf,L);Lf.prototype.K=function(a){void 0===a.h&&Cf(a);var b=a.h;void 0===a.i&&Cf(a);this.i=new Dc(b,a.i)};
...
;function Qf(){Mf.apply(this,arguments)}
v(Qf,Mf);function Of(a,b,c){void 0!==c&&Number.isNaN(Number(c))&&(c=void 0);var d=A("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):Jf(a,c||0)}
function Rf(a){if(void 0===a||!Number.isNaN(Number(a))){var b=A("yt.scheduler.instance.cancelJob");b?b(a):Kf(a)}}
Qf.prototype.start=function(){var a=A("yt.scheduler.instance.start");a&&a()};
Qf.prototype.pause=function(){var a=A("yt.scheduler.instance.pause");a&&a()};Qf.h||(Qf.h=new Qf);var Sf={};
function Tf(a){var b=void 0===a?{}:a;a=void 0===b.Va?!0:b.Va;b=void 0===b.jb?!1:b.jb;if(null==A("_lact",window)){var c=parseInt(E("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;z("_lact",c,window);z("_fact",c,window);-1==c&&Uf();Gf(document,"keydown",Uf);Gf(document,"keyup",Uf);Gf(document,"mousedown",Uf);Gf(document,"mouseup",Uf);a&&(b?Gf(window,"touchmove",function(){Vf("touchmove",200)},{passive:!0}):(Gf(window,"resize",function(){Vf("resize",200)}),Gf(window,"scroll",function(){Vf("scroll",200)})));
new Lf(function(){Vf("mouse",100)});
Gf(document,"touchstart",Uf,{passive:!0});Gf(document,"touchend",Uf,{passive:!0})}}
function Vf(a,b){Sf[a]||(Sf[a]=!0,Pf(function(){Uf();Sf[a]=!1},b))}
...
;var $f=/^[\w.]*$/,ag={q:!0,search_query:!0};function bg(a,b){b=a.split(b);for(var c={},d=0,e=b.length;d<e;d++){var f=b[d].split("=");if(1==f.length&&f[0]||2==f.length)try{var g=cg(f[0]||""),h=cg(f[1]||"");g in c?Array.isArray(c[g])?cb(c[g],h):c[g]=[c[g],h]:c[g]=h}catch(n){var k=n,l=f[0],p=String(bg);k.args=[{key:l,value:f[1],query:a,method:dg==p?"unchanged":p}];ag.hasOwnProperty(l)||tf(k)}}return c}
var dg=String(bg);function eg(a){var b=[];db(a,function(c,d){var e=encodeURIComponent(String(d)),f;Array.isArray(c)?f=c:f=[c];D(f,function(g){""==g?b.push(e):b.push(e+"="+encodeURIComponent(String(g)))})});
return b.join("&")}
...
;function jg(a){var b=kg;a=void 0===a?A("yt.ads.biscotti.lastId_")||"":a;var c=Object,d=c.assign,e={};e.dt=Vc;e.flash="0";a:{try{var f=b.h.top.location.href}catch(Ua){f=2;break a}f=f?f===b.i.location.href?0:1:2}e=(e.frm=f,e);e.u_tz=-(new Date).getTimezoneOffset();var g=void 0===g?H:g;try{var h=g.history.length}catch(Ua){h=0}e.u_his=h;e.u_java=!!H.navigator&&"unknown"!==typeof H.navigator.javaEnabled&&!!H.navigator.javaEnabled&&H.navigator.javaEnabled();H.screen&&(e.u_h=H.screen.height,e.u_w=H.screen.width,
...
function ug(a,b){b.includeDomain&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=E("XSRF_FIELD_NAME",void 0);if(b=b.urlParams)b[c]&&delete b[c],a=hg(a,b||{},!0);return a}
function vg(a,b){var c=E("XSRF_FIELD_NAME",void 0),d=E("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.postParams,g=E("XSRF_FIELD_NAME",void 0),h;b.headers&&(h=b.headers["Content-Type"]);b.excludeXsrf||bc(a)&&!b.withCredentials&&bc(a)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.postParams&&b.postParams[g]||(f||(f={}),f[c]=d);f&&"string"===typeof e&&(e=fg(e),nb(e,f),e=b.postBodyFormat&&"JSON"==b.postBodyFormat?JSON.stringify(e):dc(e));f=e||f&&!gb(f);!qg&&f&&
"POST"!=b.method&&(qg=!0,sf(Error("AJAX request with postData should use POST")));return e}
function xg(a,b,c,d){var e=null;switch(b){case "JSON":try{var f=c.responseText}catch(g){throw d=Error("Error reading responseText"),d.params=a,tf(d),g;}a=c.getResponseHeader("Content-Type")||"";f&&0<=a.indexOf("json")&&(")]}'\n"===f.substring(0,5)&&(f=f.substring(5)),e=JSON.parse(f));break;case "XML":if(a=(a=c.responseXML)?yg(a):null)e={},D(a.getElementsByTagName("*"),function(g){e[g.tagName]=zg(g)})}d&&Ag(e);
return e}
function Ag(a){if(Ia(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Sb(a[b],null);a[c]=d}else Ag(a[b])}}
function yg(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function zg(a){var b="";D(a.childNodes,function(c){b+=c.nodeValue});
return b}
function wg(a,b,c,d,e,f,g){function h(){4==(k&&"readyState"in k?k.readyState:0)&&b&&rf(b)(k)}
c=void 0===c?"GET":c;d=void 0===d?"":d;var k=mg();if(!k)return null;"onloadend"in k?k.addEventListener("loadend",h,!1):k.onreadystatechange=h;O("debug_forward_web_query_parameters")&&(a=sg(a));k.open(c,a,!0);f&&(k.responseType=f);g&&(k.withCredentials=!0);c="POST"==c&&(void 0===window.FormData||!(d instanceof FormData));if(e=rg(a,e))for(var l in e)k.setRequestHeader(l,e[l]),"content-type"==l.toLowerCase()&&(c=!1);c&&k.setRequestHeader("Content-Type","application/x-www-form-urlencoded");k.send(d);
return k}
;var Bg=wc||xc;function Cg(a){var b=Nb;return b?0<=b.toLowerCase().indexOf(a):!1}
;var Dg={},Eg=0;
function Fg(a,b,c,d,e){e=void 0===e?"":e;if(a)if(c&&!Cg("cobalt")){if(a){a instanceof Fb||(a="object"==typeof a&&a.Y?a.X():String(a),Kb.test(a)?a=new Fb(a,Gb):(a=String(a),a=a.replace(/(%0A|%0D)/g,""),a=(b=a.match(Jb))&&Ib.test(b[1])?new Fb(a,Gb):null));a=Hb(a||Mb);if("about:invalid#zClosurez"===a||a.startsWith("data"))a="";else{if(!(a instanceof Qb)){b="object"==typeof a;var f=null;b&&a.ta&&(f=a.qa());a=Sb(xb(b&&a.Y?a.X():String(a)),f)}a instanceof Qb&&a.constructor===Qb?a=a.h:(Ga(a),a="type_error:SafeHtml");
a=encodeURIComponent(String(xe(a.toString())))}/^[\s\xa0]*$/.test(a)||(a=Ic("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+'+"\\"></body>"',style:"display:none"}),(9==a.nodeType?a:a.ownerDocument||a.document).body.appendChild(a))}}else if(e)wg(a,b,"POST",e,d);else if(E("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d)wg(a,b,"GET","",d);else{b:{try{var g=new Ta({url:a});if(g.j&&g.i||g.l){var h=ac(a.match($b)[5]||null),k;if(!(k=!h||!h.endsWith("/aclk"))){var l=a.search(fc);d:{for(c=0;0<=(c=a.indexOf("ri",
c))&&c<l;){var p=a.charCodeAt(c-1);if(38==p||63==p){var n=a.charCodeAt(c+2);if(!n||61==n||38==n||35==n){var t=c;break d}}c+=3}t=-1}if(0>t)var q=null;else{var B=a.indexOf("&",t);if(0>B||B>l)B=l;t+=3;q=decodeURIComponent(a.substr(t,B-t).replace(/\+/g," "))}k="1"!==q}f=!k;break b}}catch(I){}f=!1}f?Gg(a)?(b&&b(),f=!0):f=!1:f=!1;f||Hg(a,b)}}
function Ig(a,b,c){c=void 0===c?"":c;Gg(a,c)?b&&b():Fg(a,b,void 0,void 0,c)}
...
try{Mg[a]?f():Jf(f,0)}catch(g){sf(g)}},void 0);
Kg[d]=!0;Lg[a]||(Lg[a]=[]);Lg[a].push(d);return d}return 0}
function Pg(a){var b=Og();b&&("number"===typeof a?a=[a]:"string"===typeof a&&(a=[parseInt(a,10)]),D(a,function(c){b.unsubscribeByKey(c);delete Kg[c]}))}
...
function Sg(a){Lg[a]&&(a=Lg[a],D(a,function(b){Kg[b]&&delete Kg[b]}),a.length=0)}
M.prototype.subscribe=M.prototype.subscribe;M.prototype.unsubscribeByKey=M.prototype.da;M.prototype.publish=M.prototype.W;M.prototype.clear=M.prototype.clear;z("ytPubsubPubsubInstance",Jg,void 0);z("ytPubsubPubsubTopicToKeys",Lg,void 0);z("ytPubsubPubsubIsSynchronous",Mg,void 0);z("ytPubsubPubsubSubscribedKeys",Kg,void 0);var Tg=window,P=Tg.ytcsi&&Tg.ytcsi.now?Tg.ytcsi.now:Tg.performance&&Tg.performance.timing&&Tg.performance.now&&Tg.performance.timing.navigationStart?function(){return Tg.performance.timing.navigationStart+Tg.performance.now()}:function(){return(new Date).getTime()};var Ug=xf("initial_gel_batch_timeout",2E3),Vg=Math.pow(2,16)-1,Wg=null,Xg=0,Yg=void 0,Zg=0,$g=0,ah=0,bh=!0,ch=y.ytLoggingTransportGELQueue_||new Map;z("ytLoggingTransportGELQueue_",ch,void 0);var dh=y.ytLoggingTransportTokensToCttTargetIds_||{};z("ytLoggingTransportTokensToCttTargetIds_",dh,void 0);
function eh(a,b){if("log_event"===a.endpoint){var c="";a.ja?c="visitorOnlyApprovedKey":a.G&&(dh[a.G.token]=fh(a.G),c=a.G.token);var d=ch.get(c)||[];ch.set(c,d);d.push(a.payload);b&&(Yg=new b);a=xf("tvhtml5_logging_max_batch")||xf("web_logging_max_batch")||100;b=P();d.length>=a?gh({writeThenSend:!0}):10<=b-ah&&(hh(),ah=b)}}
function ih(a,b){if("log_event"===a.endpoint){var c="";a.ja?c="visitorOnlyApprovedKey":a.G&&(dh[a.G.token]=fh(a.G),c=a.G.token);var d=new Map;d.set(c,[a.payload]);b&&(Yg=new b);return new Ee(function(e){Yg&&Yg.isReady()?jh(d,e,{bypassNetworkless:!0}):e()})}}
function gh(a){a=void 0===a?{}:a;new Ee(function(b){Kf(Zg);Kf($g);$g=0;Yg&&Yg.isReady()?(jh(ch,b,a),ch.clear()):(hh(),b())})}
function hh(){O("web_gel_timeout_cap")&&!$g&&($g=Jf(function(){gh({writeThenSend:!0})},6E4));
Kf(Zg);var a=E("LOGGING_BATCH_TIMEOUT",xf("web_gel_debounce_ms",1E4));O("shorten_initial_gel_batch_timeout")&&bh&&(a=Ug);Zg=Jf(function(){gh({writeThenSend:!0})},a)}
function jh(a,b,c){var d=Yg;c=void 0===c?{}:c;var e=Math.round(P()),f=a.size;a=u(a);for(var g=a.next();!g.done;g=a.next()){var h=u(g.value);g=h.next().value;var k=h.next().value;h=lb({context:kh(d.h||lh())});h.events=k;(k=dh[g])&&mh(h,g,k);delete dh[g];g="visitorOnlyApprovedKey"===g;nh(h,e,g);O("send_beacon_before_gel")&&window.navigator&&window.navigator.sendBeacon&&!c.writeThenSend&&Ig("/generate_204");oh(d,"log_event",h,{retry:!0,onSuccess:function(){f--;f||b();Xg=Math.round(P()-e)},
onError:function(){f--;f||b()},
Ia:c,ja:g});bh=!1}}
function nh(a,b,c){a.requestTimeMs=String(b);O("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);!c&&(b=E("EVENT_ID",void 0))&&((c=E("BATCH_CLIENT_COUNTER",void 0)||0)||(c=Math.floor(Math.random()*Vg/2)),c++,c>Vg&&(c=1),N("BATCH_CLIENT_COUNTER",c),b={serializedEventId:b,clientCounter:String(c)},a.serializedClientEventId=b,Wg&&Xg&&O("log_gel_rtt_web")&&(a.previousBatchInfo={serializedClientEventId:Wg,roundtripMs:String(Xg)}),Wg=b,Xg=0)}
...
;var ph=y.ytLoggingGelSequenceIdObj_||{};z("ytLoggingGelSequenceIdObj_",ph,void 0);function qh(a,b,c,d){d=void 0===d?{}:d;var e={},f=Math.round(d.timestamp||P());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=Wf();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};O("log_sequence_info_on_gel_web")&&d.U&&(a=e.context,b=d.U,ph[b]=b in ph?ph[b]+1:0,a.sequence={index:ph[b],groupKey:b},d.Ta&&delete ph[d.U]);(d.Zk?ih:eh)({endpoint:"log_event",payload:e,G:d.G,ja:d.ja},c)}
...
;function sh(a,b,c,d,e){cd.set(""+a,b,{wa:c,path:"/",domain:void 0===d?"youtube.com":d,secure:void 0===e?!1:e})}
;var th=A("ytglobal.prefsUserPrefsPrefs_")||{};z("ytglobal.prefsUserPrefsPrefs_",th,void 0);function uh(){this.h=E("ALT_PREF_COOKIE_NAME","PREF");this.i=E("ALT_PREF_COOKIE_DOMAIN","youtube.com");var a=cd.get(""+this.h,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(th[d]=c.toString())}}}
...
Fa(uh);var yh={bluetooth:"CONN_DISCO",cellular:"CONN_CELLULAR_UNKNOWN",ethernet:"CONN_WIFI",none:"CONN_NONE",wifi:"CONN_WIFI",wimax:"CONN_CELLULAR_4G",other:"CONN_UNKNOWN",unknown:"CONN_UNKNOWN","slow-2g":"CONN_CELLULAR_2G","2g":"CONN_CELLULAR_2G","3g":"CONN_CELLULAR_3G","4g":"CONN_CELLULAR_4G"},zh={"slow-2g":"EFFECTIVE_CONNECTION_TYPE_SLOW_2G","2g":"EFFECTIVE_CONNECTION_TYPE_2G","3g":"EFFECTIVE_CONNECTION_TYPE_3G","4g":"EFFECTIVE_CONNECTION_TYPE_4G"};
function Ah(){var a=y.navigator;return a?a.connection:void 0}
;function Bh(){return"INNERTUBE_API_KEY"in of&&"INNERTUBE_API_VERSION"in of}
function lh(){return{innertubeApiKey:E("INNERTUBE_API_KEY",void 0),innertubeApiVersion:E("INNERTUBE_API_VERSION",void 0),Wa:E("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Xa:E("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:E("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),Za:E("INNERTUBE_CONTEXT_HL",void 0),Ya:E("INNERTUBE_CONTEXT_GL",void 0),ab:E("INNERTUBE_HOST_OVERRIDE",void 0)||"",cb:!!E("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),bb:!!E("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
!1),appInstallData:E("SERIALIZED_CLIENT_CONFIG_DATA",void 0)}}
function kh(a){var b={client:{hl:a.Za,gl:a.Ya,clientName:a.Xa,clientVersion:a.innertubeContextClientVersion,configInfo:a.Wa}},c=y.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=E("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=[];var d=E("EXPERIMENTS_FORCED_FLAGS",{});for(e in d)c.push({key:e,value:String(d[e])});var e=E("EXPERIMENT_FLAGS",{});for(var f in e)f.startsWith("force_")&&void 0===d[f]&&c.push({key:f,value:String(e[f])});0<c.length&&(b.request={internalExperimentFlags:c});
f=b.client.clientName;if("WEB"===f||"MWEB"===f||1===f||2===f){if(!O("web_include_display_mode_killswitch")){var g;b.client.mainAppWebInfo=null!=(g=b.client.mainAppWebInfo)?g:{};b.client.mainAppWebInfo.webDisplayMode=rh()}}else if(g=b.client.clientName,("WEB_REMIX"===g||76===g)&&!O("music_web_display_mode_killswitch")){var h;b.client.Ha=null!=(h=b.client.Ha)?h:{};b.client.Ha.webDisplayMode=rh()}a.appInstallData&&(b.client.configInfo=b.client.configInfo||{},b.client.configInfo.appInstallData=a.appInstallData);
E("DELEGATED_SESSION_ID")&&!O("pageid_as_header_web")&&(b.user={onBehalfOfUser:E("DELEGATED_SESSION_ID")});a:{if(h=Ah()){a=yh[h.type||"unknown"]||"CONN_UNKNOWN";h=yh[h.effectiveType||"unknown"]||"CONN_UNKNOWN";"CONN_CELLULAR_UNKNOWN"===a&&"CONN_UNKNOWN"!==h&&(a=h);if("CONN_UNKNOWN"!==a)break a;if("CONN_UNKNOWN"!==h){a=h;break a}}a=void 0}a&&(b.client.connectionType=a);O("web_log_effective_connection_type")&&(a=Ah(),a=null!==a&&void 0!==a&&a.effectiveType?zh.hasOwnProperty(a.effectiveType)?zh[a.effectiveType]:
...
function Ch(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||E("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Qk||E("AUTHORIZATION"))||(a?b="Bearer "+A("gapi.auth.getToken")().Pk:b=gd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=E("SESSION_INDEX",0),O("pageid_as_header_web")&&(d["X-Goog-PageId"]=E("DELEGATED_SESSION_ID")));return d}
;function Dh(a){a=Object.assign({},a);delete a.Authorization;var b=gd();if(b){var c=new yd;c.update(E("INNERTUBE_API_KEY",void 0));c.update(b);a.hash=Bc(c.digest())}return a}
;function Eh(a){var b=new ff;(b=b.isAvailable()?a?new mf(b,a):b:null)||(a=new gf(a||"UserDataSharedStore"),b=a.isAvailable()?a:null);this.h=(a=b)?new bf(a):null;this.i=document.domain||window.location.hostname}
Eh.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.h)try{this.h.set(a,b,Date.now()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(xe(b))}catch(f){return}else e=escape(b);sh(a,e,c,this.i)};
Eh.prototype.get=function(a,b){var c=void 0,d=!this.h;if(!d)try{c=this.h.get(a)}catch(e){d=!0}if(d&&(c=cd.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
Eh.prototype.remove=function(a){this.h&&this.h.remove(a);var b=this.i;cd.remove(""+a,"/",void 0===b?"youtube.com":b)};var Fh;function Gh(){Fh||(Fh=new Eh("yt.innertube"));return Fh}
...
function Jh(a){var b=Gh().get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(P())-d.requestTime)){var e=d.authState,f=Dh(Ch(!1));jb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(P())),oh(a,d.method,e,{}));delete b[c]}}Gh().set("requests",b,86400,!0)}}
;function Kh(a,b){this.version=a;this.args=b}
;function Lh(a,b){this.topic=a;this.h=b}
Lh.prototype.toString=function(){return this.topic};var Mh=A("ytPubsub2Pubsub2Instance")||new M;M.prototype.subscribe=M.prototype.subscribe;M.prototype.unsubscribeByKey=M.prototype.da;M.prototype.publish=M.prototype.W;M.prototype.clear=M.prototype.clear;z("ytPubsub2Pubsub2Instance",Mh,void 0);var Nh=A("ytPubsub2Pubsub2SubscribedKeys")||{};z("ytPubsub2Pubsub2SubscribedKeys",Nh,void 0);var Oh=A("ytPubsub2Pubsub2TopicToKeys")||{};z("ytPubsub2Pubsub2TopicToKeys",Oh,void 0);var Ph=A("ytPubsub2Pubsub2IsAsync")||{};z("ytPubsub2Pubsub2IsAsync",Ph,void 0);
...
bb(k.args))}catch(n){throw n.message="yt.pubsub2.Data.deserialize(): "+n.message,n;}}catch(n){throw n.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+n.message,n;}a.call(window,f)}catch(n){sf(n)}},Ph[b.toString()]?A("yt.scheduler.instance")?Pf(g):Jf(g,0):g())});
...
return b}
function Wh(a){var b=Rh();b&&("number"===typeof a&&(a=[a]),D(a,function(c){b.unsubscribeByKey(c);delete Nh[c]}))}
function Rh(){return A("ytPubsub2Pubsub2Instance")}
;function Xh(){}
;var Yh=function(){var a;return function(){a||(a=new Eh("ytidb"));return a}}();
function Zh(){var a;return null===(a=Yh())||void 0===a?void 0:a.get("LAST_RESULT_ENTRY_KEY",!0)}
function $h(a){this.h=void 0===a?!1:a;(a=Zh())||(a={hasSucceededOnce:this.h});this.i=a;var b,c;O("ytidb_analyze_is_supported")&&(null===(c=Yh())||void 0===c?0:c.h)&&(c={hasSucceededOnce:this.i.hasSucceededOnce||this.h},null===(b=Yh())||void 0===b?void 0:b.set("LAST_RESULT_ENTRY_KEY",c,2592E3,!0))}
$h.prototype.isSupported=function(){return this.h};var ai=[],bi=!1;function ci(a){bi||(ai.push({type:"ERROR",payload:a}),10<ai.length&&ai.shift())}
function di(a,b){bi||(ai.push({type:"EVENT",eventType:a,payload:b}),10<ai.length&&ai.shift())}
;function ei(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);this.args=[].concat(c instanceof Array?c:fa(u(c)))}
v(ei,Error);function fi(){if(void 0!==E("DATASYNC_ID",void 0))return E("DATASYNC_ID",void 0);throw new ei("Datasync ID not set","unknown");}
...
mi.UNKNOWN_ABORT=!0,mi);function Q(a,b,c,d,e){b=void 0===b?{}:b;c=void 0===c?ji[a]:c;d=void 0===d?li[a]:d;e=void 0===e?ni[a]:e;ei.call(this,c,Object.assign({name:"YtIdbKnownError",isSw:void 0===self.document,isIframe:self!==self.top,type:a},b));this.type=a;this.message=c;this.level=d;this.h=e;Object.setPrototypeOf(this,Q.prototype)}
v(Q,ei);function oi(a){Q.call(this,"MISSING_OBJECT_STORE",{Uk:a},ji.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,oi.prototype)}
v(oi,Q);var pi=["The database connection is closing","Can't start a transaction on a closed database","A mutation operation was attempted on a database that did not allow mutations"];
function qi(a,b,c){b=hi(b);var d=a instanceof Error?a:Error("Unexpected error: "+a);if(d instanceof Q)return d;if("QuotaExceededError"===d.name)return new Q("QUOTA_EXCEEDED",{objectStoreNames:c,dbName:b});if(yc&&"UnknownError"===d.name)return new Q("QUOTA_MAYBE_EXCEEDED",{objectStoreNames:c,dbName:b});if("InvalidStateError"===d.name&&pi.some(function(e){return d.message.includes(e)}))return new Q("EXECUTE_TRANSACTION_ON_CLOSED_DB",{objectStoreNames:c,
...
R.all=function(a){return new R(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={aa:0};f.aa<a.length;f={aa:f.aa},++f.aa)ti(R.resolve(a[f.aa]).then(function(g){return function(h){d[g.aa]=h;e--;0===e&&b(d)}}(f)),function(g){c(g)})})};
...
R.prototype.then=function(a,b){var c=this,d=null!==a&&void 0!==a?a:si,e=null!==b&&void 0!==b?b:ri;return new R(function(f,g){"PENDING"===c.state.status?(c.h.push(function(){ui(c,c,d,f,g)}),c.onRejected.push(function(){vi(c,c,e,f,g)})):"FULFILLED"===c.state.status?ui(c,c,d,f,g):"REJECTED"===c.state.status&&vi(c,c,e,f,g)})};
function ti(a,b){a.then(void 0,b)}
function ui(a,b,c,d,e){try{if("FULFILLED"!==a.state.status)throw Error("calling handleResolve before the promise is fulfilled.");var f=c(a.state.value);f instanceof R?wi(a,b,f,d,e):d(f)}catch(g){e(g)}}
function vi(a,b,c,d,e){try{if("REJECTED"!==a.state.status)throw Error("calling handleReject before the promise is rejected.");var f=c(a.state.reason);f instanceof R?wi(a,b,f,d,e):d(f)}catch(g){e(g)}}
function wi(a,b,c,d,e){b===c?e(new TypeError("Circular promise chain detected.")):c.then(function(f){f instanceof R?wi(a,b,f,d,e):d(f)},function(f){e(f)})}
...
function zi(a){return new R(function(b,c){xi(a,b,c)})}
;function Ai(a,b){return new R(function(c,d){function e(){var f=a?b(a):null;f?f.then(function(g){a=g;e()},d):c()}
e()})}
;function Bi(a,b){this.h=a;this.options=b;this.transactionCount=0;this.j=Math.round(P());this.i=!1}
...
function Ci(a,b,c,d){return G(a,function f(){var g=this,h,k,l,p,n,t,q,B,I,J,U,V;return x(f,function(K){switch(K.h){case 1:var T={mode:"readonly",I:!1};"string"===typeof c?T.mode=c:T=c;h=T;g.transactionCount++;k=h.I?xf("ytidb_transaction_try_count",1):1;l=0;case 2:if(p){K.A(3);break}l++;n=Math.round(P());ra(K,4);t=g.h.transaction(b,h.mode);T=new Hi(t);T=Ii(T,d);return w(K,T,6);case 6:return q=K.i,B=Math.round(P()),Ji(g,n,B,l,void 0,b.join(),h),K.return(q);case 4:I=sa(K);J=Math.round(P());U=qi(I,g.h.name,
b.join());if((V=U instanceof Q&&!U.h)||l>=k)Ji(g,n,J,l,U,b.join(),h),p=U;K.A(2);break;case 3:return K.return(Promise.reject(p))}})})}
function Ji(a,b,c,d,e,f,g){b=c-b;e?(e instanceof Q&&("QUOTA_EXCEEDED"===e.type||"QUOTA_MAYBE_EXCEEDED"===e.type)&&di("QUOTA_EXCEEDED",{dbName:hi(a.h.name),objectStoreNames:f,transactionCount:a.transactionCount,transactionMode:g.mode}),e instanceof Q&&"UNKNOWN_ABORT"===e.type&&(di("TRANSACTION_UNEXPECTEDLY_ABORTED",{objectStoreNames:f,transactionDuration:b,transactionCount:a.transactionCount,dbDuration:c-a.j}),a.i=!0),Ki(a,!1,d,f,b),ci(e)):Ki(a,!0,d,f,b)}
function Ki(a,b,c,d,e){di("TRANSACTION_ENDED",{objectStoreNames:d,connectionHasUnknownAbortedTransaction:a.i,duration:e,isSuccessful:b,tryCount:c})}
...
function Ii(a,b){var c=new Promise(function(d,e){try{ti(b(a).then(function(f){d(f)}),e)}catch(f){e(f),a.abort()}});
return Promise.all([c,a.done]).then(function(d){return u(d).next().value})}
Hi.prototype.abort=function(){this.h.abort();this.aborted=!0;throw new Q("EXPLICIT_ABORT");};
...
m.update=function(a){return zi(this.cursor.update(a))};function Ri(a,b,c){return G(this,function e(){var f,g,h,k,l,p,n,t,q,B;return x(e,function(I){if(1==I.h)return f=self.indexedDB.open(a,b),g=c,h=g.blocked,k=g.blocking,l=g.ub,p=g.upgrade,n=g.closed,q=function(){t||(t=new Bi(f.result,{closed:n}));return t},f.addEventListener("upgradeneeded",function(J){if(null===J.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");
if(null===f.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");J.dataLoss&&"none"!==J.dataLoss&&di("IDB_DATA_CORRUPTED",{reason:J.dataLossMessage||"unknown reason",dbName:hi(a)});var U=q(),V=new Hi(f.transaction);p&&p(U,J.oldVersion,J.newVersion,V)}),h&&f.addEventListener("blocked",function(){h()}),w(I,yi(f),2);
B=I.i;k&&B.addEventListener("versionchange",function(){k(q())});
B.addEventListener("close",function(){di("IDB_UNEXPECTEDLY_CLOSED",{dbName:hi(a),dbVersion:B.version});l&&l()});
return I.return(q())})})}
function Si(a,b,c){c=void 0===c?{}:c;return Ri(a,b,c)}
function Ti(a,b){b=void 0===b?{}:b;return G(this,function d(){var e,f,g;return x(d,function(h){e=self.indexedDB.deleteDatabase(a);f=b;(g=f.blocked)&&e.addEventListener("blocked",function(){g()});
return w(h,yi(e),0)})})}
...
this.h=b=e()}return this.h};var Vi=new Ui("YtIdbMeta",{Ja:{databases:!0},upgrade:function(a,b){1>b&&Ei(a,"databases",{keyPath:"actualName"})}});
function Wi(a){return G(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,Vi.open(),2);d=e.i;return e.return(Ci(d,["databases"],{I:!0,mode:"readwrite"},function(f){var g=Di(f,"databases");return g.get(a.actualName).then(function(h){if(h?a.actualName!==h.actualName||a.publicName!==h.publicName||a.userIdentifier!==h.userIdentifier||a.clearDataOnAuthChange!==h.clearDataOnAuthChange:1)return zi(g.h.put(a,void 0)).then(function(){})})}))})})}
function Xi(a){return G(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,Vi.open(),2);d=e.i;return e.return(d.delete("databases",a))})})}
function Yi(a){return G(this,function c(){var d,e;return x(c,function(f){return 1==f.h?(d=[],w(f,Vi.open(),2)):3!=f.h?(e=f.i,w(f,Ci(e,["databases"],{I:!0,mode:"readonly"},function(g){d.length=0;return Mi(Di(g,"databases"),{},function(h){a(h.getValue())&&d.push(h.getValue());return h.continue()})}),3)):f.return(d)})})}
function Zi(){return Yi(function(a){return"LogsDatabaseV2"===a.publicName&&void 0!==a.userIdentifier})}
;var $i;
function aj(){return G(this,function b(){var c,d,e;return x(b,function(f){switch(f.h){case 1:if(O("ytidb_is_supported_cache_success_result")&&(c=Zh(),null===c||void 0===c?0:c.hasSucceededOnce))return f.return(new $h(!0));var g;if(g=Bg)g=/WebKit\/([0-9]+)/.exec(Nb),g=!!(g&&600<=parseInt(g[1],10));g&&(g=/WebKit\/([0-9]+)/.exec(Nb),g=!(g&&602<=parseInt(g[1],10)));if(g||kc)return f.return(new $h(!1));try{if(d=self,!(d.indexedDB&&d.IDBIndex&&d.IDBKeyRange&&d.IDBObjectStore))return f.return(new $h(!1))}catch(h){return f.return(new $h(!1))}if(!("IDBTransaction"in self&&
"objectStoreNames"in IDBTransaction.prototype))return f.return(new $h(!1));ra(f,2);e={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0};return w(f,Wi(e),4);case 4:return w(f,Xi("yt-idb-test-do-not-use"),5);case 5:return f.return(new $h(!0));case 2:return sa(f),f.return(new $h(!1))}})})}
function bj(){if(void 0!==$i)return $i;bi=!0;return $i=aj().then(function(a){bi=!1;return a.isSupported()})}
;function cj(a){try{fi();var b=!0}catch(c){b=!1}if(!b)throw a=new Q("AUTH_INVALID"),ci(a),a;b=fi();return{actualName:a+":"+b,publicName:a,userIdentifier:b}}
function dj(a,b,c,d){var e;return G(this,function g(){var h,k;return x(g,function(l){switch(l.h){case 1:return w(l,ej({caller:"openDbImpl",publicName:a,version:b}),2);case 2:return gi(a),h=c?{actualName:a,publicName:a,userIdentifier:void 0}:cj(a),h.clearDataOnAuthChange=null!==(e=d.clearDataOnAuthChange)&&void 0!==e?e:!1,ra(l,3),w(l,Wi(h),5);case 5:return w(l,Si(h.actualName,b,d),6);case 6:return l.return(l.i);case 3:return k=sa(l),ra(l,7),w(l,Xi(h.actualName),9);case 9:l.h=8;l.m=0;break;case 7:sa(l);
case 8:throw k;}})})}
function ej(a){return G(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,bj(),2);if(!e.i)throw d=new Q("IDB_NOT_SUPPORTED",{context:a}),ci(d),d;e.h=0})})}
function fj(a,b,c){c=void 0===c?{}:c;return dj(a,b,!1,c)}
function gj(a,b,c){c=void 0===c?{}:c;return dj(a,b,!0,c)}
function hj(a,b){b=void 0===b?{}:b;return G(this,function d(){var e;return x(d,function(f){if(1==f.h)return w(f,bj(),2);if(3!=f.h){if(!f.i)return f.return();gi(a);e=cj(a);return w(f,Ti(e.actualName,b),3)}return w(f,Xi(e.actualName),0)})})}
function ij(a,b){var c=this;a=a.map(function(d){return G(c,function f(){return x(f,function(g){return 1==g.h?w(g,Ti(d.actualName,b),2):w(g,Xi(d.actualName),0)})})});
return Promise.all(a).then(function(){})}
function jj(){var a=void 0===a?{}:a;return G(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,bj(),2);if(3!=e.h){if(!e.i)return e.return();gi("LogsDatabaseV2");return w(e,Zi(),3)}d=e.i;return w(e,ij(d,a),0)})})}
function kj(a,b){b=void 0===b?{}:b;return G(this,function d(){return x(d,function(e){if(1==e.h)return w(e,bj(),2);if(3!=e.h){if(!e.i)return e.return();gi(a);return w(e,Ti(a,b),3)}return w(e,Xi(a),0)})})}
;function lj(a,b){Ui.call(this,a,b);this.options=b;gi(a)}
v(lj,Ui);lj.prototype.i=function(a,b,c){c=void 0===c?{}:c;return(this.options.Ma?gj:fj)(a,b,Object.assign(Object.assign({},c),{clearDataOnAuthChange:this.options.clearDataOnAuthChange}))};
lj.prototype.delete=function(a){a=void 0===a?{}:a;return(this.options.Ma?kj:hj)(this.name,a)};
function mj(a){var b;return function(){b||(b=new lj("LogsDatabaseV2",a));return b}}
;function nj(){R.call(this,function(){});
throw Error("Not allowed to instantiate the thennable outside of the core library.");}
v(nj,R);nj.reject=R.reject;nj.resolve=R.resolve;nj.all=R.all;var oj;function pj(){if(!oj){var a={};oj=mj({Ja:(a.LogsRequestsStore=!0,a.sapisid=!0,a.SWHealthLog=!0,a),Ma:!O("nwl_use_ytidb_partitioning"),upgrade:function(b,c){2>c&&(Ei(b,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0}).h.createIndex("newRequest",["status","authHash","interface","timestamp"],{unique:!1}),Ei(b,"sapisid"));3>c&&Ei(b,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).h.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
version:3})}return oj().open()}
function qj(a){return G(this,function c(){var d,e,f,g,h;return x(c,function(k){switch(k.h){case 1:return d={startTime:P(),transactionType:"YT_IDB_TRANSACTION_TYPE_WRITE"},w(k,rj(),2);case 2:return e=k.i,w(k,pj(),3);case 3:return f=k.i,g=Object.assign(Object.assign({},a),{options:JSON.parse(JSON.stringify(a.options)),authHash:e,interface:E("INNERTUBE_CONTEXT_CLIENT_NAME",0)}),w(k,Gi(f,"LogsRequestsStore",g),4);case 4:return h=k.i,d.vb=P(),sj(d),k.return(h)}})})}
function tj(a){return G(this,function c(){var d,e,f,g,h,k,l,p;return x(c,function(n){switch(n.h){case 1:return d={startTime:P(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},w(n,rj(),2);case 2:return e=n.i,f=E("INNERTUBE_CONTEXT_CLIENT_NAME",0),g=[a,e,f,0],h=[a,e,f,P()],k=IDBKeyRange.bound(g,h),w(n,pj(),3);case 3:return l=n.i,p=void 0,w(n,Ci(l,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(t){return Pi(Di(t,"LogsRequestsStore").index("newRequest"),{query:k,direction:"prev"},function(q){q.getValue()&&
(p=q.getValue(),"NEW"===a&&(p.status="QUEUED",q.update(p)))})}),4);
case 4:return d.vb=P(),sj(d),n.return(p)}})})}
function uj(a){return G(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,pj(),2);d=e.i;return e.return(Ci(d,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(f){var g=Di(f,"LogsRequestsStore");return g.get(a).then(function(h){if(h)return h.status="QUEUED",zi(g.h.put(h,void 0)).then(function(){return h})})}))})})}
function vj(a){return G(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,pj(),2);d=e.i;return e.return(Ci(d,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(f){var g=Di(f,"LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",h.sendCount+=1,zi(g.h.put(h,void 0)).then(function(){return h})):nj.resolve(void 0)})}))})})}
function wj(a){return G(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,pj(),2);d=e.i;return e.return(d.delete("LogsRequestsStore",a))})})}
function xj(){return G(this,function b(){var c;return x(b,function(d){if(1==d.h)return w(d,pj(),2);c=d.i;return d.return(c.clear("LogsRequestsStore"))})})}
function yj(){return G(this,function b(){var c;return x(b,function(d){if(1==d.h)return w(d,pj(),2);c=d.i;return d.return(c.clear("SWHealthLog"))})})}
function zj(){return G(this,function b(){var c,d;return x(b,function(e){return 1==e.h?w(e,pj(),2):3!=e.h?(c=e.i,d=P()-2592E6,w(e,Ci(c,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(f){return Mi(Di(f,"LogsRequestsStore"),{},function(g){if(g.getValue().timestamp<=d)return g.delete().then(function(){return g.continue()})})}),3)):O("web_clean_sw_logs_store")?w(e,Ci(c,["SWHealthLog"],{mode:"readwrite",
...
function Aj(){return G(this,function b(){return x(b,function(c){return 1==c.h?w(c,jj(),2):w(c,kj("LogsDatabaseV2"),0)})})}
function rj(){return G(this,function b(){var c;return x(b,function(d){if(1==d.h){Xh.h||(Xh.h=new Xh);var e={};var f=gd([]);f&&(e.Authorization=f,f=void 0,void 0===f&&(f=Number(E("SESSION_INDEX",0)),f=isNaN(f)?0:f),e["X-Goog-AuthUser"]=f,"INNERTUBE_HOST_OVERRIDE"in of||(e["X-Origin"]=window.location.origin),O("pageid_as_header_web")&&"DELEGATED_SESSION_ID"in of&&(e["X-Goog-PageId"]=E("DELEGATED_SESSION_ID")));e instanceof Ee||(f=new Ee(Ea),Fe(f,2,e),e=f);return w(d,e,2)}c=d.i;e=d.return;f=Dh(c);var g=
...
function Bj(a){return G(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,pj(),2);d=e.i;return w(e,Gi(d,"sapisid",a,"sapisid"),0)})})}
function Cj(){return G(this,function b(){var c,d;return x(b,function(e){if(1==e.h)return w(e,pj(),2);if(3!=e.h)return c=e.i,w(e,c.get("sapisid","sapisid"),3);d=e.i;return e.return(d||"")})})}
function sj(a){var b=xf("nwl_latency_sampling_rate",.01);.02<b||Math.random()<=b&&Qh("nwl_transaction_latency_payload",a)}
;var Dj=["__Secure-1PAPISID","SAPISID","__Secure-3PAPISID"];function Ej(){for(var a=u(Dj),b=a.next();!b.done;b=a.next())if(b=cd.get(b.value))return b;return"LOGGED_OUT"}
function Fj(){pe.call(this);this.pollingInterval=3E3;this.i=[null,null,null];this.m=!1;Gj(this)}
v(Fj,pe);function Hj(){Fj.h||(Fj.h=new Fj);var a=Fj.h;a.m=!0;a.verifyUser();Ij(a)}
Fj.prototype.verifyUser=function(){var a=Gj(this),b=a.fb;if(!a.tb)return Ij(this),!0;qe(this,"ytsessionchange");b&&qe(this,"ytuserinvalid");Ij(this);return!1};
function Gj(a){var b=Dj.map(function(e){var f;return null!==(f=cd.get(e))&&void 0!==f?f:""}),c=b.some(function(e,f){return a.i&&""!==a.i[f]&&""===e}),d=b.some(function(e,f){return a.i&&a.i[f]!==e});
a.i=b;return{fb:c,tb:d}}
function Ij(a){a.m&&(Jj(a),a.l=Nf(function(){a.verifyUser()},a.pollingInterval))}
function Jj(a){a.l&&(Rf(a.l),a.l=void 0)}
;var Kj;function Lj(){Kj||(Kj=new Eh("yt.offline"));return Kj}
function Mj(a){if(O("offline_error_handling")){var b=Lj().get("errors",!0)||{};b[a.message]={name:a.name,stack:a.stack};a.level&&(b[a.message].level=a.level);Lj().set("errors",b,2592E3,!0)}}
function Nj(){if(O("offline_error_handling")){var a=Lj().get("errors",!0);if(a){for(var b in a)if(a[b]){var c=new ei(b,"sent via offline_errors");c.name=a[b].name;c.stack=a[b].stack;c.level=a[b].level;sf(c)}Lj().set("errors",{},2592E3,!0)}}}
;var Oj=xf("network_polling_interval",3E4);function S(){pe.call(this);this.L=0;this.o=this.l=!1;this.B=0;this.m=this.J=!1;this.i=this.ka();this.m=O("validate_network_status");Pj(this);Qj(this)}
v(S,pe);function Rj(){if(!S.h){var a=A("yt.networkStatusManager.instance")||new S;z("yt.networkStatusManager.instance",a,void 0);S.h=a}return S.h}
m=S.prototype;m.M=function(){this.m||this.i===this.ka()||tf(new ei("NetworkStatusManager isOnline does not match window status"));return this.i};
m.gb=function(a){this.l=!0;if(void 0===a?0:a)this.L||Sj(this)};
...
function Qj(a){window.addEventListener("online",function(){return G(a,function c(){var d=this;return x(c,function(e){if(1==e.h)return d.m?w(e,d.T(),2):(d.i=!0,d.l&&qe(d,"ytnetworkstatus-online"),e.A(2));Tj(d);d.J&&Nj();e.h=0})})})}
function Pj(a){window.addEventListener("offline",function(){return G(a,function c(){var d=this;return x(c,function(e){if(1==e.h)return d.m?w(e,d.T(),2):(d.i=!1,d.l&&qe(d,"ytnetworkstatus-offline"),e.A(2));Tj(d);e.h=0})})})}
function Sj(a){a.L=Nf(function(){return G(a,function c(){var d=this;return x(c,function(e){if(1==e.h){if(O("trigger_nsm_validation_checks_with_nwl")&&!d.i)return w(e,d.T(),3);if(d.ka()){if(!1!==d.i)return e.A(3);d.o=!0;d.B=P();return d.l?d.m?w(e,d.T(),11):(d.i=!0,qe(d,"ytnetworkstatus-online"),e.A(11)):e.A(11)}if(!0!==d.i)return e.A(3);d.o=!0;d.B=P();return d.l?d.m?w(e,d.T(),3):(d.i=!1,qe(d,"ytnetworkstatus-offline"),e.A(3)):e.A(3)}if(3!=e.h)return d.J&&Nj(),e.A(3);Sj(d);e.h=0})})},Oj)}
function Tj(a){a.o&&(tf(new ei("NetworkStatusManager state did not match poll",P()-a.B)),a.o=!1)}
m.T=function(a){var b=this;return this.C?this.C:this.C=new Promise(function(c){return G(b,function e(){var f,g,h,k=this;return x(e,function(l){switch(l.h){case 1:return f=window.AbortController?new window.AbortController:void 0,g=null===f||void 0===f?void 0:f.signal,h=!1,ra(l,2,3),f&&(k.K=Pf(function(){f.abort()},a||2E4)),w(l,fetch("/generate_204",{method:"HEAD",
signal:g}),5);case 5:h=!0;case 3:ta(l);k.C=void 0;k.K&&Rf(k.K);h!==k.i&&(k.i=h,k.i&&k.l?qe(k,"ytnetworkstatus-online"):k.l&&qe(k,"ytnetworkstatus-offline"));c(h);ua(l);break;case 2:sa(l),h=!1,l.A(3)}})})})};
S.prototype.sendNetworkCheckRequest=S.prototype.T;S.prototype.listen=S.prototype.ca;S.prototype.enableErrorFlushing=S.prototype.Ra;S.prototype.getWindowStatus=S.prototype.ka;S.prototype.monitorNetworkStatusChange=S.prototype.gb;S.prototype.isNetworkAvailable=S.prototype.M;S.getInstance=Rj;function Uj(a){a=void 0===a?{}:a;pe.call(this);var b=this;this.l=this.o=0;this.i=Rj();var c=A("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.i);c&&c(a.Sa);a.eb&&(c=A("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.i))&&c();if(c=A("yt.networkStatusManager.instance.listen").bind(this.i))a.ma?(this.ma=a.ma,c("ytnetworkstatus-online",function(){Vj(b,"publicytnetworkstatus-online")}),c("ytnetworkstatus-offline",function(){Vj(b,"publicytnetworkstatus-offline")})):
...
v(Uj,pe);Uj.prototype.M=function(){var a=A("yt.networkStatusManager.instance.isNetworkAvailable").bind(this.i);return a?a():!0};
Uj.prototype.T=function(a){return G(this,function c(){var d=this,e;return x(c,function(f){return(e=A("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(d.i))?f.return(e(a)):f.return(!0)})})};
function Vj(a,b){a.ma?a.l?(Rf(a.o),a.o=Pf(function(){a.m!==b&&(qe(a,b),a.m=b,a.l=P())},a.ma-(P()-a.l))):(qe(a,b),a.m=b,a.l=P()):qe(a,b)}
;var Wj=!1,Xj=!1,Yj=0,Zj=0,ak,bk=y.ytNetworklessLoggingInitializationOptions||{isNwlInitialized:Wj,isIdbSupported:Xj,potentialEsfErrorCounter:Zj};O("export_networkless_options")&&z("ytNetworklessLoggingInitializationOptions",bk,void 0);
function ck(){G(this,function b(){var c,d,e,f;return x(b,function(g){switch(g.h){case 1:return w(g,bj(),2);case 2:(c=g.i)&&(Xj=!0);d=O("networkless_logging");if(c&&d)return O("nwl_use_ytidb_partitioning")?w(g,kj("LogsDatabaseV2"),8):w(g,jj(),8);if(!c){g.A(0);break}return w(g,Aj(),0);case 8:return Hj(),document.addEventListener("ytsessionchange",function(){dk()}),w(g,Cj(),11);
case 11:e=g.i;f=Ej();if(e===f){g.A(12);break}dk();return w(g,Bj(f),12);case 12:if(!(O("enable_nwl_cleaning_logic")&&Math.random()<=xf("nwl_cleaning_rate",.1))){g.A(14);break}return w(g,zj(),14);case 14:Wj=!0;ek();fk().M()&&gk();fk().ca("publicytnetworkstatus-online",gk);fk().ca("publicytnetworkstatus-offline",hk);if(!O("networkless_immediately_drop_sw_health_store")){g.A(16);break}return w(g,ik(),16);case 16:if(!O("networkless_immediately_drop_all_requests")){g.A(18);break}return w(g,Aj(),18);case 18:O("export_networkless_options")&&
(bk.isNwlInitialized=Wj,bk.isIdbSupported=Xj),g.h=0}})})}
function jk(a,b){function c(d){var e=fk().M();if(!kk()||!d||e&&O("vss_networkless_bypass_write"))lk(a,b);else{var f={url:a,options:b,timestamp:P(),status:"NEW",sendCount:0};qj(f).then(function(g){f.id=g;(fk().M()||O("networkless_always_online"))&&mk(f)}).catch(function(g){mk(f);
fk().M()?sf(g):Mj(g)})}}
b=void 0===b?{}:b;O("skip_is_supported_killswitch")?bj().then(function(d){c(d)}):c(nk())}
function ok(a,b){function c(d){if(kk()&&d){var e={url:a,options:b,timestamp:P(),status:"NEW",sendCount:0},f=!1,g=b.onSuccess?b.onSuccess:function(){};
e.options.onSuccess=function(h,k){void 0!==e.id?wj(e.id):f=!0;g(h,k)};
lk(e.url,e.options);qj(e).then(function(h){e.id=h;f&&wj(e.id)}).catch(function(h){fk().M()?sf(h):Mj(h)})}else lk(a,b)}
b=void 0===b?{}:b;O("skip_is_supported_killswitch")?bj().then(function(d){c(d)}):c(nk())}
function gk(){var a=this;Yj||(Yj=Pf(function(){return G(a,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,tj("NEW"),2);if(3!=e.h)return d=e.i,d?w(e,mk(d),3):(hk(),e.return());if(!O("nwl_throttling_race_fix")||Yj)Yj=0,gk();e.h=0})})},100))}
function hk(){Rf(Yj);Yj=0}
function mk(a){return G(this,function c(){var d;return x(c,function(e){switch(e.h){case 1:if(void 0===a.id){e.A(2);break}return w(e,uj(a.id),3);case 3:(d=e.i)?a=d:tf(Error("The request cannot be found in the database."));case 2:if(pk(a,2592E6)){e.A(4);break}tf(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===a.id){e.A(5);break}return w(e,wj(a.id),5);case 5:return e.return();case 4:var f=a=qk(a),g,h;if(null===(h=null===(g=null===f||void 0===f?void 0:f.options)||void 0===
g?void 0:g.postParams)||void 0===h?0:h.requestTimeMs)f.options.postParams.requestTimeMs=Math.round(P());(a=f)&&lk(a.url,a.options);e.h=0}})})}
function qk(a){var b=this,c=a.options.onError?a.options.onError:function(){};
a.options.onError=function(e,f){return G(b,function h(){return x(h,function(k){switch(k.h){case 1:if(!(O("trigger_nsm_validation_checks_with_nwl")&&(A("ytNetworklessLoggingInitializationOptions")?bk.potentialEsfErrorCounter:Zj)<=xf("potential_esf_error_limit",10))){k.A(2);break}return w(k,fk().T(),3);case 3:if(fk().M())A("ytNetworklessLoggingInitializationOptions")&&bk.potentialEsfErrorCounter++,Zj++;else return c(e,f),k.return();case 2:if(void 0===(null===a||void 0===a?void 0:a.id)){k.A(4);break}return 1>
a.sendCount?w(k,vj(a.id),8):w(k,wj(a.id),4);case 8:Pf(function(){fk().M()&&gk()},5E3);
case 4:c(e,f),k.h=0}})})};
var d=a.options.onSuccess?a.options.onSuccess:function(){};
a.options.onSuccess=function(e,f){return G(b,function h(){return x(h,function(k){if(1==k.h)return void 0===(null===a||void 0===a?void 0:a.id)?k.A(2):w(k,wj(a.id),2);d(e,f);k.h=0})})};
return a}
function pk(a,b){a=a.timestamp;return P()-a>=b?!1:!0}
function ek(){var a=this;tj("QUEUED").then(function(b){b&&!pk(b,12E4)?Pf(function(){return G(a,function d(){return x(d,function(e){if(1==e.h)return void 0===b.id?e.A(2):w(e,vj(b.id),2);ek();e.h=0})})}):O("nwl_trigger_throttle_after_reset")&&fk().M()&&gk()})}
function dk(){xj().catch(function(a){sf(a)})}
function ik(){return G(this,function b(){return x(b,function(c){return c.return(yj().catch(function(d){sf(d)}))})})}
function fk(){ak||(ak=new Uj({eb:!0,Sa:O("trigger_nsm_validation_checks_with_nwl")}));return ak}
function lk(a,b){if(O("networkless_with_beacon")){var c=["method","postBody"];if(Object.keys(b).length>c.length)var d=!0;else{d=0;c=u(c);for(var e=c.next();!e.done;e=c.next())b.hasOwnProperty(e.value)&&d++;d=Object.keys(b).length!==d}d?tg(a,b):Ig(a,void 0,b.postBody)}else tg(a,b)}
function kk(){return A("ytNetworklessLoggingInitializationOptions")?bk.isNwlInitialized:Wj}
function nk(){return A("ytNetworklessLoggingInitializationOptions")?bk.isIdbSupported:Xj}
;function rk(a){var b=this;this.h=null;a?this.h=a:Bh()&&(this.h=lh());Nf(function(){Jh(b)},5E3)}
rk.prototype.isReady=function(){!this.h&&Bh()&&(this.h=lh());return!!this.h};
function oh(a,b,c,d){function e(t){t=void 0===t?!1:t;var q;if(d.retry&&"www.youtube-nocookie.com"!=h&&(t||(q=Hh(b,c,l,k)),q)){var B=g.onSuccess,I=g.onFetchSuccess;g.onSuccess=function(J,U){Ih(q);B(J,U)};
c.onFetchSuccess=function(J,U){Ih(q);I(J,U)}}try{t&&d.retry&&!d.Ia.bypassNetworkless?(g.method="POST",!d.Ia.writeThenSend&&O("nwl_send_fast_on_unload")?ok(n,g):jk(n,g)):(g.method="POST",g.postParams||(g.postParams={}),tg(n,g))}catch(J){if("InvalidAccessError"==J.name)q&&(Ih(q),q=0),tf(Error("An extension is blocking network request."));
else throw J;}q&&Nf(function(){Jh(a)},5E3)}
!E("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&tf(new ei("Missing VISITOR_DATA when sending innertube request.",b,c,d));if(!a.isReady()){var f=new ei("innertube xhrclient not ready",b,c,d);sf(f);throw f;}var g={headers:{"Content-Type":"application/json"},method:"POST",postParams:c,postBodyFormat:"JSON",onTimeout:function(){d.onTimeout()},
...
timeout:d.timeout,withCredentials:!0},h="";(f=a.h.ab)&&(h=f);var k=a.h.cb||!1,l=Ch(k,h,d);Object.assign(g.headers,l);g.headers.Authorization&&!h&&(g.headers["x-origin"]=window.location.origin);f="/youtubei/"+a.h.innertubeApiVersion+"/"+b;var p={alt:"json"};a.h.bb&&g.headers.Authorization||(p.key=a.h.innertubeApiKey);var n=hg(""+h+f,p||{},!0);kk()?bj().then(function(t){e(t)}):e(!1)}
;function sk(a,b,c){c=void 0===c?{}:c;var d=rk;E("ytLoggingEventsDefaultDisabled",!1)&&rk==rk&&(d=null);qh(a,b,d,c)}
;var tk=[{Ga:function(a){return"Cannot read property '"+a.key+"'"},
...
groups:["key"]},{regexp:/\uac1c\uccb4\uac00 '([^']+)' \uc18d\uc131\uc774\ub098 \uba54\uc11c\ub4dc\ub97c \uc9c0\uc6d0\ud558\uc9c0 \uc54a\uc2b5\ub2c8\ub2e4./,groups:["key"]}]}}];var vk={S:[],R:[{Aa:uk,weight:500}]};function uk(a){a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function wk(){this.R=[];this.S=[]}
var xk;function yk(){if(!xk){var a=xk=new wk;a.S.length=0;a.R.length=0;vk.S&&a.S.push.apply(a.S,vk.S);vk.R&&a.R.push.apply(a.R,vk.R)}return xk}
;var zk=new M;function Ak(a){function b(){return a.charCodeAt(d++)}
...
a.fileName),d.push("Stacktrace: "+a.stack),window.console.log(d.join("\n"),a)),!(5<=Gk))){var g=Ad(a);d=g.message||"Unknown Error";e=g.name||"UnknownError";var h=g.stack||a.i||"Not available";h.startsWith(e+": "+d)&&(f=h.split("\n"),f.shift(),h=f.join("\n"));f=g.lineNumber||"Not available";g=g.fileName||"Not available";var k=0;if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var l=0;l<a.args.length&&!(k=Ck(a.args[l],"params."+l,c,k),500<=k);l++);else if(a.hasOwnProperty("params")&&a.params){var p=
a.params;if("object"===typeof a.params)for(l in p){if(p[l]){var n="params."+l,t=Ek(p[l]);c[n]=t;k+=n.length+t.length;if(500<k)break}}else c.params=Ek(p)}if(Jk.length)for(l=0;l<Jk.length&&!(k=Ck(Jk[l],"params.context."+l,c,k),500<=k);l++);navigator.vendor&&!c.hasOwnProperty("vendor")&&(c["device.vendor"]=navigator.vendor);l={message:d,name:e,lineNumber:f,fileName:g,stack:h,params:c,sampleWeight:1};c=Number(a.columnNumber);isNaN(c)||(l.lineNumber=l.lineNumber+":"+c);if("IGNORED"===a.level)a=0;else a:{a=
yk();c=u(a.S);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.Tk)){a=d.weight;break a}a=u(a.R);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Aa(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(tk);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.xa[l.name])for(e=u(c.xa[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=
d[g+1];l.message=c.Ga(f);break}l.params||(l.params={});a=yk();l.params["params.errorServiceSignature"]="msg="+a.S.length+"&cb="+a.R.length;l.params["params.serviceWorker"]="false";y.document&&y.document.querySelectorAll&&(l.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));window.yterr&&"function"===typeof window.yterr&&window.yterr(l);if(0!==l.sampleWeight&&!Fk.has(l.message)){"ERROR"===b?(zk.W("handleError",l),O("record_app_crashed_web")&&0===Ik&&1===l.sampleWeight&&
(Ik++,sk("appCrashed",{appCrashType:"APP_CRASH_TYPE_BREAKPAD"})),Hk++):"WARNING"===b&&zk.W("handleWarning",l);if(O("kevlar_gel_error_routing")){a=b;b:{c=u(Kk);for(d=c.next();!d.done;d=c.next())if(Cg(d.value.toLowerCase())){c=!0;break b}c=!1}if(c)c=void 0;else{d={stackTrace:l.stack};l.fileName&&(d.filename=l.fileName);c=l.lineNumber&&l.lineNumber.split?l.lineNumber.split(":"):[];0!==c.length&&(1!==c.length||isNaN(Number(c[0]))?2!==c.length||isNaN(Number(c[0]))||isNaN(Number(c[1]))||(d.lineNumber=Number(c[0]),
...
;var Ok={hc:3611,wb:27686,xb:85013,yb:23462,Ab:42016,Bb:62407,Cb:26926,zb:43781,Db:51236,Eb:79148,Fb:50160,Gb:77504,Sb:87907,Tb:18630,Ub:54445,Vb:80935,Wb:105675,Xb:37521,Yb:47786,Zb:98349,ac:123695,cc:6827,dc:29434,ec:7282,fc:124448,kc:32276,jc:76278,lc:93911,mc:106531,nc:27259,oc:27262,pc:27263,sc:21759,tc:27107,uc:62936,wc:49568,xc:38408,yc:80637,zc:68727,Ac:68728,Bc:80353,Cc:80356,Dc:74610,Ec:45707,Fc:83962,Gc:83970,Hc:46713,Ic:89711,Jc:74612,Kc:93265,Lc:74611,Nc:113533,Oc:93252,Pc:99357,Rc:94521,
...
Hk:39579,Ik:39578,Jk:77448,Kk:8196,Lk:11357,Mk:69877,Nk:8197,Ok:82039};function Pk(){var a=kb(Qk),b;return Le(new Ee(function(c,d){a.onSuccess=function(e){ng(e)?c(new Rk(e)):d(new Sk("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new Sk("Unknown request error","net.unknown",e))};
a.onTimeout=function(e){d(new Sk("Request timed out","net.timeout",e))};
b=tg("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Me&&b.abort();
return Je(c)})}
function Sk(a,b,c){Sa.call(this,a+", errorCode="+b);this.errorCode=b;this.xhr=c;this.name="PromiseAjaxError"}
v(Sk,Sa);function Rk(a){this.xhr=a}
;function Tk(){this.i=0;this.h=null}
Tk.prototype.then=function(a,b,c){return 1===this.i&&a?(a=a.call(c,this.h),De(a)?a:Uk(a)):2===this.i&&b?(a=b.call(c,this.h),De(a)?a:Vk(a)):this};
Tk.prototype.getValue=function(){return this.h};
Tk.prototype.$goog_Thenable=!0;function Vk(a){var b=new Tk;a=void 0===a?null:a;b.i=2;b.h=void 0===a?null:a;return b}
function Uk(a){var b=new Tk;a=void 0===a?null:a;b.i=1;b.h=void 0===a?null:a;return b}
;function Wk(a){Sa.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Xk;this.isTimeout=a instanceof Sk&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Me}
v(Wk,Sa);Wk.prototype.name="BiscottiError";function Xk(){Sa.call(this,"Biscotti ID is missing from server")}
v(Xk,Sa);Xk.prototype.name="BiscottiMissingError";var Qk={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Yk=null;function Yf(){if(O("condition_biscotti_fetch_on_consent_cookie_html5_clients")&&!cd.get("CONSENT","").startsWith("YES+"))return Je(Error("User has not consented - not fetching biscotti id."));if("1"==ib())return Je(Error("Biscotti ID is not available in private embed mode"));Yk||(Yk=Le(Pk().then(Zk),function(a){return $k(2,a)}));
return Yk}
function Zk(a){a=a.xhr.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new Xk;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new Xk;a=a.id;Zf(a);Yk=Uk(a);al(18E5,2);return a}
function $k(a,b){b=new Wk(b);Zf("");Yk=Vk(b);0<a&&al(12E4,a-1);throw b;}
function al(a,b){Jf(function(){Le(Pk().then(Zk,function(c){return $k(b,c)}),Ea)},a)}
function bl(){try{var a=A("yt.ads.biscotti.getId_");return a?a():Yf()}catch(b){return Je(b)}}
;function cl(a){if("1"!=ib()){a&&Xf();try{bl().then(function(){},function(){}),Jf(cl,18E5)}catch(b){sf(b)}}}
...
return a.join("")}
;var fl,gl=y.ytLoggingDocDocumentNonce_;gl||(gl=el(),Qa("ytLoggingDocDocumentNonce_",gl));fl=gl;var hl={je:0,ic:1,qc:2,ph:3,le:4,wk:5,ci:6,ej:7,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE"};function il(a){this.h=a}
...
function ml(a){return E(ll(void 0===a?0:a),void 0)}
...
function ol(){var a=E("csn-to-ctt-auth-info");a||(a={},N("csn-to-ctt-auth-info",a));return a}
function pl(a){a=void 0===a?0:a;var b=E(kl(a));if(!b&&!E("USE_CSN_FALLBACK",!0))return null;b||0!=a||(b="UNDEFINED_CSN");return b?b:null}
...
z("yt_logging_screen.getCttAuthInfo",rl,void 0);function sl(a,b,c,d){c=void 0===c?0:c;if(a!==E(kl(c))||b!==E(ll(c)))ql(a,d,c),N(kl(c),a),N(ll(c),b),b=function(){setTimeout(function(){a&&qh("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:fl,clientScreenNonce:a},rk)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
z("yt_logging_screen.setCurrentScreen",sl,void 0);function tl(a){Kh.call(this,1,arguments);this.csn=a}
v(tl,Kh);var Th=new Lh("screen-created",tl),ul=[],wl=vl,xl=0;function yl(a,b,c,d){var e=d.filter(function(f){f.csn!==b?(f.csn=b,f=!0):f=!1;return f});
c={csn:b,parentVe:c.getAsJson(),childVes:Ya(e,function(f){return f.getAsJson()})};
d=u(d);for(e=d.next();!e.done;e=d.next())e=e.value.getAsJson(),(gb(e)||!e.trackingParams&&!e.veType)&&Lk(Error("Child VE logged with no data"));d={G:rl(b),U:b};"UNDEFINED_CSN"==b?zl("visualElementAttached",c,d):a?qh("visualElementAttached",c,a,d):sk("visualElementAttached",c,d)}
function vl(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return Bc(b)}
function zl(a,b,c){ul.push({payloadName:a,payload:b,options:c});xl||(xl=Uh())}
function Vh(a){if(ul){for(var b=u(ul),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,qh(c.payloadName,c.payload,null,c.options));ul.length=0}xl=0}
;function Al(){this.i=new Set;this.h=new Set;this.j=new Map}
Al.prototype.clear=function(){this.i.clear();this.h.clear();this.j.clear()};
Fa(Al);function Bl(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!Cl(a)||c.some(function(e){return!Cl(e)}))throw Error("Only objects may be merged.");
...
function Fl(a,b){b=u(b);for(var c=b.next();!c.done;c=b.next())c=c.value,Cl(c)?a.push(Dl({},c)):El(c)?a.push(Fl([],c)):a.push(c);return a}
function Cl(a){return"object"===typeof a&&!Array.isArray(a)}
function El(a){return"object"===typeof a&&Array.isArray(a)}
;function Gl(a,b){Kh.call(this,1,arguments)}
v(Gl,Kh);function Hl(a,b){Kh.call(this,1,arguments)}
v(Hl,Kh);var Il=new Lh("aft-recorded",Gl),Jl=new Lh("timing-sent",Hl);var Kl=window;function Ll(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var W=Kl.performance||Kl.mozPerformance||Kl.msPerformance||Kl.webkitPerformance||new Ll;var Ml=!1,Nl={'script[name="scheduler/scheduler"]':"sj",'script[name="player/base"]':"pj",'link[rel="stylesheet"][name="www-player"]':"pc",'link[rel="stylesheet"][name="player/www-player"]':"pc",'script[name="desktop_polymer/desktop_polymer"]':"dpj",'link[rel="import"][name="desktop_polymer"]':"dph",'script[name="mobile-c3/mobile-c3"]':"mcj",'link[rel="stylesheet"][name="mobile-c3"]':"mcc",'script[name="player-plasma-ias-phone/base"]':"mcppj",'script[name="player-plasma-ias-tablet/base"]':"mcptj",
'link[rel="stylesheet"][name="mobile-polymer-player-ias"]':"mcpc",'link[rel="stylesheet"][name="mobile-polymer-player-svg-ias"]':"mcpsc",'script[name="mobile_blazer_core_mod"]':"mbcj",'link[rel="stylesheet"][name="mobile_blazer_css"]':"mbc",'script[name="mobile_blazer_logged_in_users_mod"]':"mbliuj",'script[name="mobile_blazer_logged_out_users_mod"]':"mblouj",'script[name="mobile_blazer_noncore_mod"]':"mbnj","#player_css":"mbpc",'script[name="mobile_blazer_desktopplayer_mod"]':"mbpj",'link[rel="stylesheet"][name="mobile_blazer_tablet_css"]':"mbtc",
'script[name="mobile_blazer_watch_mod"]':"mbwj"};Oa(W.clearResourceTimings||W.webkitClearResourceTimings||W.mozClearResourceTimings||W.msClearResourceTimings||W.oClearResourceTimings||Ea,W);function Ol(a){var b=Pl(a);if(b.aft)return b.aft;a=E((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function Ql(){var a;if(O("csi_use_performance_navigation_timing")){var b,c,d,e=null===(d=null===(c=null===(b=null===(a=null===W||void 0===W?void 0:W.getEntriesByType)||void 0===a?void 0:a.call(W,"navigation"))||void 0===b?void 0:b[0])||void 0===c?void 0:c.toJSON)||void 0===d?void 0:d.call(c);e?(e.requestStart=Rl(e.requestStart),e.responseEnd=Rl(e.responseEnd),e.redirectStart=Rl(e.redirectStart),e.redirectEnd=Rl(e.redirectEnd),e.domainLookupEnd=Rl(e.domainLookupEnd),e.connectStart=Rl(e.connectStart),
e.connectEnd=Rl(e.connectEnd),e.responseStart=Rl(e.responseStart),e.secureConnectionStart=Rl(e.secureConnectionStart),e.domainLookupStart=Rl(e.domainLookupStart),e.isPerformanceNavigationTiming=!0,a=e):a=W.timing}else a=W.timing;return a}
function Sl(){return O("csi_use_time_origin")&&W.timeOrigin?Math.floor(W.timeOrigin):W.timing.navigationStart}
function Rl(a){return Math.round(Sl()+a)}
function Tl(a){var b;(b=A("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Qa("ytcsi."+(a||"")+"data_",b));return b}
function Ul(a){a=Tl(a);a.info||(a.info={});return a.info}
function Pl(a){a=Tl(a);a.tick||(a.tick={});return a.tick}
function Vl(a){var b=Tl(a).nonce;b||(b=el(),Tl(a).nonce=b);return b}
function Wl(a){var b=Pl(a||""),c=Ol(a);c&&!Ml&&(Qh(Il,new Gl(Math.round(c-b._start),a)),Ml=!0)}
;function Xl(){if(W.getEntriesByType){var a=W.getEntriesByType("paint");if(a=$a(a,function(b){return"first-paint"===b.name}))return Rl(a.startTime)}a=W.timing;
return a.hb?Math.max(0,a.hb):0}
;function Yl(){var a=A("ytcsi.debug");a||(a=[],z("ytcsi.debug",a,void 0),z("ytcsi.reference",{},void 0));return a}
function Zl(a){a=a||"";var b=A("ytcsi.reference");b||(Yl(),b=A("ytcsi.reference"));if(b[a])return b[a];var c=Yl(),d={timerName:a,info:{},tick:{},span:{}};c.push(d);return b[a]=d}
;var $l=y.ytLoggingLatencyUsageStats_||{};z("ytLoggingLatencyUsageStats_",$l,void 0);function am(){this.h=0}
function bm(){am.h||(am.h=new am);return am.h}
am.prototype.tick=function(a,b,c){cm(this,"tick_"+a+"_"+b)||sk("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
am.prototype.info=function(a,b){var c=Object.keys(a).join("");cm(this,"info_"+c+"_"+b)||(a=Object.assign({},a),a.clientActionNonce=b,sk("latencyActionInfo",a))};
am.prototype.span=function(a,b){var c=Object.keys(a).join("");cm(this,"span_"+c+"_"+b)||(a.clientActionNonce=b,sk("latencyActionSpan",a))};
function cm(a,b){$l[b]=$l[b]||{count:0};var c=$l[b];c.count++;c.time=P();a.h||(a.h=Nf(function(){var d=P(),e;for(e in $l)$l[e]&&6E4<d-$l[e].time&&delete $l[e];a&&(a.h=0)},5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new ei("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||Lk(c)),!0):!1}
...
gm={},hm=(gm.ccs="CANARY_STATE_",gm.mver="MEASUREMENT_VERSION_",gm.pis="PLAYER_INITIALIZED_STATE_",gm.yt_pt="LATENCY_PLAYER_",gm.pa="LATENCY_ACTION_",gm.yt_vst="VIDEO_STREAM_TYPE_",gm),im="all_vc ap aq c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
function jm(a){return!!E("FORCE_CSI_ON_GEL",!1)||O("csi_on_gel")||!!Tl(a).useGel}
function km(a,b,c){var d=lm(c);d.gelTicks&&(d.gelTicks["tick_"+a]=!0);c||b||P();return jm(c)?(Zl(c||"").tick[a]=b||P(),d=Vl(c),"_start"===a?(a=bm(),cm(a,"baseline_"+d)||sk("latencyActionBaselined",{clientActionNonce:d},{timestamp:b})):bm().tick(a,d,b),Wl(c),!0):!1}
function mm(a,b,c){c=lm(c);if(c.gelInfos)c.gelInfos["info_"+a]=!0;else{var d={};c.gelInfos=(d["info_"+a]=!0,d)}if(a.match("_rid")){var e=a.split("_rid")[0];a="REQUEST_ID"}if(a in em){c=em[a];0<=Wa(fm,c)&&(b=!!b);a in hm&&"string"===typeof b&&(b=hm[a]+b.toUpperCase());a=b;b=c.split(".");for(var f=d={},g=0;g<b.length-1;g++){var h=b[g];f[h]={};f=f[h]}f[b[b.length-1]]="requestIds"===c?[{id:a,endpoint:e}]:a;return Bl({},d)}0<=Wa(im,a)||Lk(new ei("Unknown label logged with GEL CSI",a))}
function lm(a){a=Tl(a);if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}else a.gel={gelTicks:{},gelInfos:{}};return a.gel}
function nm(a){a=lm(a);a.gelInfos||(a.gelInfos={});return a.gelInfos}
;function om(a,b,c){null!==b&&(Ul(c)[a]=b,jm(c)?(a=mm(a,b,c))&&jm(c)&&(b=Zl(c||""),Bl(b.info,a),Bl(nm(c),a),c=Vl(c),bm().info(a,c)):Zl(c||"").info[a]=b)}
function Z(a,b,c){var d=Pl(c);if(!b&&"_"!==a[0]){var e=a;W.mark&&(0==e.lastIndexOf("mark_",0)||(e="mark_"+e),c&&(e+=" ("+c+")"),W.mark(e))}e=b||P();d[a]=e;km(a,b,c)||(pm(c),Zl(c||"").tick[a]=b||P());return d[a]}
function qm(a,b){if(jm(void 0)){var c=lm(void 0);if(c.gelSpans)c.gelSpans[a]=!0;else{var d={};c.gelSpans=(d[a]=!0,d)}a={spanName:a,spanLengthUsec:String(Math.round(1E3*b))};Zl("").span[String(a.spanName)]=a;b=lm(void 0);b.gelSpans||(b.gelSpans={});Bl(b.gelSpans,a);b=Vl(void 0);bm().span(a,b)}}
function rm(){var a=Vl(void 0);requestAnimationFrame(function(){setTimeout(function(){a===Vl(void 0)&&Z("ol",void 0,void 0)},0)})}
function pm(a){if(!A("yt.timing."+(a||"")+"pingSent_")){var b=E((a||"")+"TIMING_ACTION",void 0),c=Pl(a);if(b=!!A("ytglobal.timing"+(a||"")+"ready_")&&b)b="_start"in Pl(void 0);if(b&&Ol(a))if(Wl(a),a)sm(a);else{b=!0;var d=E("TIMING_WAIT",[]);if(d.length)for(var e=0,f=d.length;e<f;++e)if(!(d[e]in c)){b=!1;break}b&&sm(a)}}}
function tm(){var a=document;if("visibilityState"in a)a=a.visibilityState;else{var b=zf+"VisibilityState";a=b in a?a[b]:void 0}switch(a){case "hidden":return 0;case "visible":return 1;case "prerender":return 2;case "unloaded":return 3;default:return-1}}
function sm(a){if(!jm(a)){var b=Pl(a),c=Ul(a),d=b._start,e=E("CSI_SERVICE_NAME","youtube"),f={v:2,s:e,action:E((a||"")+"TIMING_ACTION",void 0)},g=c.srt;void 0!==b.srt&&delete c.srt;b.aft=Ol(a);var h=Pl(a),k=h.pbr,l=h.vc;h=h.pbs;k&&l&&h&&k<l&&l<h&&Ul(a).yt_pvis&&"youtube"===e&&(om("yt_lt","hot_bg",a),e=b.vc,k=b.pbs,delete b.aft,c.aft=Math.round(k-e));for(var p in c)"_"!==p.charAt(0)&&(f[p]=c[p]);b.ps=P();p={};e=[];for(var n in b)"_"!==n.charAt(0)&&(k=Math.round(b[n]-d),p[n]=k,e.push(n+"."+k));f.rt=
e.join(",");b=!!c.ap;c="";for(var t in f)f.hasOwnProperty(t)&&(c+="&"+t+"="+f[t]);f="/csi_204?"+c.substring(1);window.navigator&&window.navigator.sendBeacon&&(b||O("always_send_csi_204_with_beacon"))?Ig(f):Fg(f);z("yt.timing."+(a||"")+"pingSent_",!0,void 0);Qh(Jl,new Hl(p.aft+(Number(g)||0),a))}}
function um(a,b){a=document.querySelector(a);if(!a)return!1;var c="",d=a.nodeName;"SCRIPT"===d?(c=a.src,c||(c=a.getAttribute("data-timing-href"))&&(c=window.location.protocol+c)):"LINK"===d&&(c=a.href);Wb()&&a.setAttribute("nonce",Wb());return c?(a=W.getEntriesByName(c))&&a[0]&&(a=a[0],c=Sl(),Z("rsf_"+b,c+Math.round(a.fetchStart)),Z("rse_"+b,c+Math.round(a.responseEnd)),void 0!==a.transferSize&&(b=Ul(void 0),c=nm(void 0),"rc"in b||"rc"in c||om("rc",""),0===a.transferSize))?!0:!1:!1}
function vm(){var a=window.location.protocol,b=W.getEntriesByType("resource");b=Xa(b,function(c){return 0===c.name.indexOf(a+"//fonts.gstatic.com/s/")});
(b=Za(b,function(c,d){return d.duration>c.duration?d:c},{duration:0}))&&0<b.startTime&&0<b.responseEnd&&(Z("wffs",Rl(b.startTime)),Z("wffe",Rl(b.responseEnd)))}
var wm=window;wm.ytcsi&&(wm.ytcsi.info=om,wm.ytcsi.tick=Z);function xm(){this.l=[];this.u=[];this.h=[];this.i=new Set;this.m=new Map}
function ym(a,b,c){c=void 0===c?0:c;b.then(function(d){var e,f;a.i.has(c)&&a.j&&a.j();var g=pl(c),h=nl(c);g&&h&&(d.csn=g,(null===(e=d.response)||void 0===e?0:e.trackingParams)&&yl(a.client,g,h,[jl(d.response.trackingParams)]),(null===(f=d.playerResponse)||void 0===f?0:f.trackingParams)&&yl(a.client,g,h,[jl(d.playerResponse.trackingParams)]))})}
function zm(a,b,c,d){d=void 0===d?0:d;if(a.i.has(d))a.l.push([b,c]);else{var e=pl(d);c=c||nl(d);e&&c&&yl(a.client,e,c,[b])}}
xm.prototype.clickCommand=function(a,b,c){c=pl(void 0===c?0:c);if(!a.clickTrackingParams||!c)return!1;var d=this.client;var e="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";a={csn:c,ve:jl(a.clickTrackingParams).getAsJson(),gestureType:e};b&&(a.clientData=b);b={G:rl(c),U:c};"UNDEFINED_CSN"==c?zl("visualElementGestured",a,b):d?qh("visualElementGestured",a,d,b):sk("visualElementGestured",a,b);return!0};
function Am(a,b,c){c=void 0===c?{}:c;a.i.add(c.layer||0);a.j=function(){Bm(a,b,c);var f=nl(c.layer);if(f){for(var g=u(a.l),h=g.next();!h.done;h=g.next())h=h.value,zm(a,h[0],h[1]||f,c.layer);f=u(a.u);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=pl(g);var l=k[0]||nl(g);h&&l&&(g=a.client,k=k[1],k={csn:h,ve:l.getAsJson(),clientData:k},l={G:rl(h),U:h},"UNDEFINED_CSN"==h?zl("visualElementStateChanged",k,l):g?qh("visualElementStateChanged",k,g,l):sk("visualElementStateChanged",
k,l))}}};
pl(c.layer)||a.j();if(c.Da)for(var d=u(c.Da),e=d.next();!e.done;e=d.next())ym(a,e.value,c.layer);else Mk(Error("Delayed screen needs a data promise."))}
function Bm(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.ib?c.ib:c.layer;var e=pl(d);d=nl(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=E("EVENT_ID");O("screen_manager_log_servlet_ei")&&"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=a.client;h=f;var l=c.Ca,p=c.G,n=wl(),t={csn:n,pageVe:(new il({veType:b,youtubeData:g})).getAsJson()};h&&
h.visualElement?t.implicitGesture={parentCsn:h.clientScreenNonce,gesturedVe:h.visualElement.getAsJson()}:h&&Lk(new ei("newScreen() parent element does not have a VE - rootVe",b));l&&(t.cloneCsn=l);l={G:p,U:n};k?qh("screenCreated",t,k,l):sk("screenCreated",t,l);Qh(Th,new tl(n));var q=n}catch(B){Nk(B,{Xk:b,rootVe:d,parentVisualElement:void 0,Sk:e,Wk:f,Ca:c.Ca});Mk(B);return}sl(q,b,c.layer,c.G);if((b=e&&"UNDEFINED_CSN"!==e&&d)&&!(b=O("screen_manager_skip_hide_killswitch"))){a:{b=u(Object.values(hl));
for(f=b.next();!f.done;f=b.next())if(pl(f.value)==e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,f=!0,k=(f=void 0===f?!1:f)?16:8,d={csn:e,ve:d.getAsJson(),eventType:k},f={G:rl(e),U:e,Ta:f},"UNDEFINED_CSN"==e?zl("visualElementHidden",d,f):b?qh("visualElementHidden",d,b,f):sk("visualElementHidden",d,f));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=q||"");om("csn",q);Al.getInstance().clear();d=nl(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(O("web_mark_root_visible")||O("music_web_mark_root_visible"))&&
(e=q,q=O("use_default_events_client")?void 0:rk,b={csn:e,ve:d.getAsJson(),eventType:1},f={G:rl(e),U:e},"UNDEFINED_CSN"==e?zl("visualElementShown",b,f):q?qh("visualElementShown",b,q,f):sk("visualElementShown",b,f));a.i.delete(c.layer||0);a.j=void 0;e=u(a.m);for(q=e.next();!q.done;q=e.next())q=u(q.value),b=q.next().value,q.next().value.has(c.layer)&&d&&zm(a,b,d,c.layer)}
;function Cm(a){a&&(a.dataset?a.dataset[Dm("loaded")]="true":a.setAttribute("data-loaded","true"))}
function Em(a,b){return a?a.dataset?a.dataset[Dm(b)]:a.getAttribute("data-"+b):null}
var Fm={};function Dm(a){return Fm[a]||(Fm[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var Gm=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,Hm=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;function Im(a,b,c){c=void 0===c?null:c;if(window.spf&&spf.script){c="";if(a){var d=a.indexOf("jsbin/"),e=a.lastIndexOf(".js"),f=d+6;-1<d&&-1<e&&e>f&&(c=a.substring(f,e),c=c.replace(Gm,""),c=c.replace(Hm,""),c=c.replace("debug-",""),c=c.replace("tracing-",""))}spf.script.load(a,c,b)}else Jm(a,b,c)}
function Jm(a,b,c){c=void 0===c?null:c;var d=Km(a),e=document.getElementById(d),f=e&&Em(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=Ng(d,b),b=""+Ja(b),Lm[b]=f),g||(e=Mm(a,d,function(){Em(e,"loaded")||(Cm(e),Qg(d),Jf(Pa(Rg,d),0))},c)))}
function Mm(a,b,c,d){d=void 0===d?null:d;var e=Jc(document,"SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function Nm(a){a=Km(a);var b=document.getElementById(a);b&&(Rg(a),b.parentNode.removeChild(b))}
function Om(a,b){a&&b&&(a=""+Ja(b),(a=Lm[a])&&Pg(a))}
function Km(a){var b=document.createElement("a");Tb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Zb(a)}
var Lm={};var Pm=[],Qm=!1;function Rm(){if((!O("condition_ad_status_fetch_on_consent_cookie_html5_clients")||cd.get("CONSENT","").startsWith("YES+"))&&"1"!=ib()){var a=function(){Qm=!0;"google_ad_status"in window?N("DCLKSTAT",1):N("DCLKSTAT",2)};
try{Im("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Pm.push(Pf(function(){if(!(Qm||"google_ad_status"in window)){try{Om("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Qm=!0;N("DCLKSTAT",3)}},5E3))}}
function Sm(){var a=Number(E("DCLKSTAT",0));return isNaN(a)?0:a}
;function Tm(){this.i=!1;this.h=null}
Tm.prototype.initialize=function(a,b,c,d){d=void 0===d?!1:d;var e,f;if(a.program){var g=null!==(e=a.interpreterScript)&&void 0!==e?e:null,h=null!==(f=a.interpreterUrl)&&void 0!==f?f:null;if(a.interpreterSafeScript){g=a.interpreterSafeScript.privateDoNotAccessOrElseSafeScriptWrappedValue||"";var k=pb();g=k?k.createScript(g):g;g=(new rb(g)).toString()}a.interpreterSafeUrl&&(h=vb(a.interpreterSafeUrl.privateDoNotAccessOrElseTrustedResourceUrlWrappedValue||"").toString());Um(this,g,h,a.program,b,c,d)}else Lk(Error("Cannot initialize botguard without program"))};
function Um(a,b,c,d,e,f,g){g=void 0===g?!1:g;c?(a.i=!0,Im(c,function(){a.i=!1;var h=0<=c.indexOf("/th/");(h?window.trayride:window.botguard)?Vm(a,d,!!g,h,e):(Nm(c),Lk(new ei("Unable to load Botguard","from "+c)))},f)):b&&(f=Jc(document,"SCRIPT"),f.textContent=b,f.nonce=Wb(),document.head.appendChild(f),document.head.removeChild(f),((b=b.includes("trayride"))?window.trayride:window.botguard)?Vm(a,d,!!g,b,e):Lk(Error("Unable to load Botguard from JS")))}
function Vm(a,b,c,d,e){var f,g;if(d=d?null===(f=window.trayride)||void 0===f?void 0:f.ad:null===(g=window.botguard)||void 0===g?void 0:g.bg)if(c)try{Wm(a,new d(b,e?function(){return e(b)}:Ea))}catch(h){h instanceof Error&&Lk(h)}else{try{Wm(a,new d(b))}catch(h){h instanceof Error&&Lk(h)}e&&e(b)}else Lk(Error("Failed to finish initializing VM"))}
Tm.prototype.invoke=function(a){a=void 0===a?{}:a;return this.h?this.h.hasOwnProperty("hot")?this.h.hot(void 0,void 0,a):this.h.invoke(void 0,void 0,a):null};
Tm.prototype.dispose=function(){this.h=null};
function Wm(a,b){a.h=b}
;var Xm=new Tm;function Ym(){return!!Xm.h}
function Zm(a){a=void 0===a?{}:a;return Xm.invoke(a)}
;var $m=window,an=/[A-Za-z]+\/[0-9.]+/g;function bn(a,b){if(a.replace(an,"")!==b.replace(an,""))return!1;a=a.match(an);b=b.match(an);if(a.length!==b.length)return!1;for(var c=0;c<a.length;c++){var d=a[c],e=b[c];if(!d.startsWith(e)&&!e.startsWith(d))return!1}return!0}
function cn(){var a=$m.uaChPolyfill.state;if(0===a.type)sk("clientHintsPolyfillEvent",{clientHintsSupported:!1});else{var b=navigator.userAgent,c=void 0!==a.syntheticUa&&bn(a.syntheticUa,b);sk("clientHintsPolyfillEvent",{clientHintsSupported:!0,uaAccessedBeforePolyfill:a.didAccessUaBeforePolyfillAvailable,syntheticUaMatches:c});c||(b={syntheticUa:a.syntheticUa,ua:b},b.brand=a.data.brands.map(function(d){return'"'+d.brand+'"; v="'+d.version+'"'}),b.mobileness=a.data.mobile,a=a.data.values,a.architecture&&
(b.platformArchitecture=a.architecture),a.model&&(b.model=a.model),a.platform&&(b.platformBrand=a.platform),a.platformVersion&&(b.platformVersion=a.platformVersion),a.uaFullVersion&&(b.fullVersion=a.uaFullVersion),sk("clientHintsPolyfillDiagnostics",b))}}
var dn=!1;function en(){var a;1===(null===(a=$m.uaChPolyfill)||void 0===a?void 0:a.state.type)?dn||($m.uaChPolyfill.onReady=en,dn=!0):$m.uaChPolyfill&&cn()}
;function fn(a,b,c){L.call(this);var d=this;c=c||E("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.j=b||null;this.C="*";this.l=c;this.sessionId=null;this.channel="widget";this.F=!!a;this.B=function(e){a:if(!("*"!=d.l&&e.origin!=d.l||d.j&&e.source!=d.j||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.F&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
v(fn,L);fn.prototype.sendMessage=function(a,b){if(b=b||this.j){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var c=JSON.stringify(a);b.postMessage(c,this.C)}catch(d){tf(d)}}};
fn.prototype.D=function(){window.removeEventListener("message",this.B);L.prototype.D.call(this)};function gn(){this.i=[];this.isReady=!1;this.j={};var a=this.h=new fn(!!E("WIDGET_ID_ENFORCE")),b=this.kb.bind(this);a.m=b;a.o=null;this.h.channel="widget";if(a=E("WIDGET_ID"))this.h.sessionId=a}
m=gn.prototype;m.kb=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.j[a]||"onReady"===a||(this.addEventListener(a,hn(this,a)),this.j[a]=!0)):this.ya(a,b,c)};
m.ya=function(){};
function hn(a,b){return function(c){return a.sendMessage(b,c)}}
...
function jn(a,b){a.sendMessage("infoDelivery",b)}
...
m.dispose=function(){this.h=null};function kn(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function ln(a,b,c){if("string"===typeof a)return{videoId:a,startSeconds:b,suggestedQuality:c};b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}
function mn(a,b,c,d){if(Ia(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
;function nn(a){gn.call(this);this.listeners=[];this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.qb.bind(this));this.addEventListener("onVolumeChange",this.rb.bind(this));this.addEventListener("onApiChange",this.lb.bind(this));this.addEventListener("onPlaybackQualityChange",this.nb.bind(this));this.addEventListener("onPlaybackRateChange",this.ob.bind(this));this.addEventListener("onStateChange",this.pb.bind(this));this.addEventListener("onWebglSettingsChanged",
this.sb.bind(this))}
v(nn,gn);m=nn.prototype;
m.ya=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&kn(a)){var d=b;if(Ia(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=ln(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
d[2];break b}d=null}e.videoId=d;e=ln(e);break;case "loadPlaylist":case "cuePlaylist":e=mn(d[0],d[1],d[2],d[3])}b.length=1;b[0]=e}this.api.handleExternalCall(a,b,c);kn(a)&&jn(this,this.sa())}};
...
(a.videoUrl=this.api.getVideoUrl());this.api.getVideoContentRect&&(a.videoContentRect=this.api.getVideoContentRect());this.api.getProgressState&&(a.progressState=this.api.getProgressState());this.api.getPlaylist&&(a.playlist=this.api.getPlaylist());this.api.getPlaylistIndex&&(a.playlistIndex=this.api.getPlaylistIndex());this.api.getStoryboardFormat&&(a.storyboardFormat=this.api.getStoryboardFormat());jn(this,a)};
m.nb=function(a){jn(this,{playbackQuality:a})};
m.ob=function(a){jn(this,{playbackRate:a})};
...
m.rb=function(){jn(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
m.qb=function(a){a={currentTime:a,videoBytesLoaded:this.api.getVideoBytesLoaded(),videoLoadedFraction:this.api.getVideoLoadedFraction(),currentTimeLastUpdated_:Date.now()/1E3,playbackRate:this.api.getPlaybackRate(),mediaReferenceTime:this.api.getMediaReferenceTime()};this.api.getProgressState&&(a.progressState=this.api.getProgressState());jn(this,a)};
m.sb=function(){var a={sphericalProperties:this.api.getSphericalProperties()};jn(this,a)};
m.dispose=function(){gn.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function on(a){L.call(this);this.i={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.Ka,this)}
v(on,L);m=on.prototype;m.start=function(){this.started||this.h||(this.started=!0,this.connection.Z("RECEIVING"))};
m.Z=function(a,b){this.started&&!this.h&&this.connection.Z(a,b)};
m.Ka=function(a,b,c){if(this.started&&!this.h){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&this.addListener(d.event);break;case "removeEventListener":"string"===typeof d.event&&this.removeListener(d.event);break;default:this.api.isReady()&&this.api.isExternalMethodAvailable(a,c||null)&&(b=pn(a,b||{}),c=this.api.handleExternalCall(a,b,c||null),(c=qn(a,c))&&this.Z(a,c))}}};
...
m.D=function(){var a=this.connection;a.h||We(a.i,"command",this.Ka,this);this.connection=null;for(var b in this.i)this.i.hasOwnProperty(b)&&this.removeListener(b);L.prototype.D.call(this)};function rn(a,b){on.call(this,b);this.api=a;this.start()}
...
function pn(a,b){switch(a){case "loadVideoById":return a=ln(b),[a];case "cueVideoById":return a=ln(b),[a];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return a=mn(b),[a];case "cuePlaylist":return a=mn(b),[a];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
...
rn.prototype.ra=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return on.prototype.ra.call(this,a,b)};
rn.prototype.D=function(){on.prototype.D.call(this);delete this.api};function sn(a){a=void 0===a?!1:a;L.call(this);this.i=new M(a);Gd(this,Pa(Ed,this.i))}
C(sn,L);sn.prototype.subscribe=function(a,b,c){return this.h?0:this.i.subscribe(a,b,c)};
sn.prototype.l=function(a,b){this.h||this.i.W.apply(this.i,arguments)};function tn(a,b,c){sn.call(this);this.j=a;this.destination=b;this.id=c}
v(tn,sn);tn.prototype.Z=function(a,b){this.h||this.j.Z(this.destination,this.id,a,b)};
tn.prototype.D=function(){this.destination=this.j=null;sn.prototype.D.call(this)};function un(a,b,c){L.call(this);this.destination=a;this.origin=c;this.i=Gf(window,"message",this.j.bind(this));this.connection=new tn(this,a,b);Gd(this,Pa(Ed,this.connection))}
v(un,L);un.prototype.Z=function(a,b,c,d){this.h||a!==this.destination||(a={id:b,command:c},d&&(a.data=d),this.destination.postMessage(xe(a),this.origin))};
un.prototype.j=function(a){var b;if(b=!this.h)if(b=a.origin===this.origin)a:{b=this.destination;do{b:{var c=a.source;do{if(c===b){c=!0;break b}if(c===c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.connection,c.h||c.l("command",b.command,b.data,a.origin))}};
un.prototype.D=function(){Hf(this.i);this.destination=null;L.prototype.D.call(this)};function vn(){L.call(this);this.i=[]}
v(vn,L);vn.prototype.D=function(){for(;this.i.length;){var a=this.i.pop();a.target.removeEventListener(a.name,a.Aa)}L.prototype.D.call(this)};function wn(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||kb(b);this.assets=a.assets||{};this.attrs=a.attrs||kb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
wn.prototype.clone=function(){var a=new wn,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Ga(c)?a[b]=kb(c):a[b]=c}return a};var xn=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function yn(a){a=a||"";if(window.spf){var b=a.match(xn);spf.style.load(a,b?b[1]:"",void 0)}else zn(a)}
function zn(a){var b=An(a),c=document.getElementById(b),d=c&&Em(c,"loaded");d||c&&!d||(c=Bn(a,b,function(){Em(c,"loaded")||(Cm(c),Qg(b),Jf(Pa(Rg,b),0))}))}
...
function An(a){var b=Jc(document,"A");Tb(b,new Fb(a,Gb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Zb(a)}
;function Cn(a,b,c,d){L.call(this);var e=this;this.F=b;this.webPlayerContextConfig=d;this.na=!1;this.api={};this.ba=this.m=null;this.J=new M;this.i={};this.L=this.fa=this.elementId=this.oa=this.config=null;this.K=!1;this.l=this.B=null;this.ga={};this.Na=["onReady"];this.lastError=null;this.za=NaN;this.C={};this.Oa=new vn(this);this.P=0;this.j=this.o=a;Gd(this,Pa(Ed,this.J));Dn(this);En(this);Gd(this,Pa(Ed,this.Oa));c?this.P=Jf(function(){e.loadNewVideoConfig(c)},0):d&&(Fn(this),Gn(this))}
v(Cn,L);m=Cn.prototype;m.getId=function(){return this.F};
m.loadNewVideoConfig=function(a){if(!this.h){this.P&&(Kf(this.P),this.P=0);var b=a||{};b instanceof wn||(b=new wn(b));this.config=b;this.setConfig(a);Gn(this);this.isReady()&&Hn(this)}};
...
function Kn(a){var b=!0,c=Ln(a);c&&a.config&&(a=Mn(a),b=Em(c,"version")===a);return b&&!!A("yt.player.Application.create")}
...
a.K=!0;b?a.B():(Im(Mn(a),a.B),(b=Qn(a))&&yn(b),Rn(a)&&!c&&z("yt.player.Application.create",null,void 0))}}}
function Ln(a){var b=Fc(a.elementId);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.elementId));return b}
function Nn(a){var b;if(!a.h){var c=Ln(a),d=!1;c&&c.getApiInterface&&c.getApiInterface()&&(d=!0);d?(a.K=!1,!Pn(a,"html5_remove_not_servable_check_killswitch")&&(null===c||void 0===c?0:c.isNotServable)&&a.config&&(null===c||void 0===c?0:c.isNotServable(null===(b=a.config.args)||void 0===b?void 0:b.video_id))||Sn(a)):a.za=Jf(function(){Nn(a)},50)}}
function Sn(a){Dn(a);a.na=!0;var b=Ln(a);if(b){a.m=Tn(a,b,"addEventListener");a.ba=Tn(a,b,"removeEventListener");var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=a.api,e=0;e<c.length;e++){var f=c[e];d[f]||(d[f]=Tn(a,b,f))}}for(var g in a.i)a.i.hasOwnProperty(g)&&a.m&&a.m(g,a.i[g]);Hn(a);a.fa&&a.fa(a.api);a.J.W("onReady",a.api)}
function Tn(a,b,c){var d=b[c];return function(e){for(var f=[],g=0;g<arguments.length;++g)f[g-0]=arguments[g];try{return a.lastError=null,d.apply(b,f)}catch(h){"sendAbandonmentPing"!==c&&(h.params=c,a.lastError=h,Lk(h))}}}
function Dn(a){a.na=!1;if(a.ba)for(var b in a.i)a.i.hasOwnProperty(b)&&a.ba(b,a.i[b]);for(var c in a.C)a.C.hasOwnProperty(c)&&Kf(Number(c));a.C={};a.m=null;a.ba=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
function En(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){Qg("WATCH_LATER_VIDEO_ADDED",b)});
...
m.addEventListener=function(a,b){var c=this,d=Jn(this,b);d&&(0<=Wa(this.Na,a)||this.i[a]||(b=Un(this,a),this.m&&this.m(a,b)),this.J.subscribe(a,d),"onReady"===a&&this.isReady()&&Jf(function(){d(c.api)},0))};
m.removeEventListener=function(a,b){this.h||(b=Jn(this,b))&&We(this.J,a,b)};
function Jn(a,b){var c=b;if("string"===typeof b){if(a.ga[b])return a.ga[b];c=function(d){for(var e=[],f=0;f<arguments.length;++f)e[f-0]=arguments[f];if(f=A(b))try{f.apply(y,e)}catch(g){Mk(g)}};
a.ga[b]=c}return c?c:null}
function Un(a,b){var c="ytPlayer"+b+a.F;a.i[b]=c;y[c]=function(d){var e=Jf(function(){if(!a.h){a.J.W(b,d);var f=a.C,g=String(e);g in f&&delete f[g]}},0);
hb(a.C,String(e))};
return c}
...
m.cancel=function(){this.B&&Om(Mn(this),this.B);Kf(this.za);this.K=!1};
m.D=function(){On(this);if(this.l&&this.config&&this.l.destroy)try{this.l.destroy()}catch(b){Mk(b)}this.ga=null;for(var a in this.i)this.i.hasOwnProperty(a)&&(y[this.i[a]]=null);this.oa=this.config=this.api=null;delete this.o;delete this.j;L.prototype.D.call(this)};
...
function Pn(a,b){var c;if(a.webPlayerContextConfig)var d=a.webPlayerContextConfig.serializedExperimentFlags;else if(null===(c=a.config)||void 0===c?0:c.args)d=a.config.args.fflags;return"true"===bg(d||"","&")[b]}
function In(a){for(var b={},c=u(Object.keys(a)),d=c.next();!d.done;d=c.next()){d=d.value;var e=a[d];b[d]="object"===typeof e?kb(e):e}return b}
;var Vn={},Wn="player_uid_"+(1E9*Math.random()>>>0);function Xn(a,b,c){var d="player";c=void 0===c?!0:c;d="string"===typeof d?Fc(d):d;var e=Wn+"_"+Ja(d),f=Vn[e];if(f&&c)return Yn(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new Cn(d,e,a,b);Vn[e]=f;Qg("player-added",f.api);Gd(f,function(){delete Vn[f.getId()]});
return f.api}
...
;function co(){if(ed())return!0;var a=E("INNERTUBE_CLIENT_NAME");return!a||"WEB"!==a&&"MWEB"!==a?!0:(a=cd.get("CONSENT",void 0))?a.startsWith("YES+"):!0}
;function eo(a,b,c){a="ST-"+Zb(a).toString(36);b=b?dc(b):"";c=c||5;O("drop_st_cookie_before_cb")&&!co()||sh(a,b,c)}
;function fo(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=E("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=E("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=bc(window.location.href);g&&f.push(g);g=bc(d);if(0<=Wa(f,g)||!g&&0==d.lastIndexOf("/",0))if(O("autoescape_tempdata_url")&&(f=document.createElement("a"),Tb(f,d),d=f.href),d){g=d.match($b);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||b.ved)&&
(b=Object.assign({csn:pl()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&eo(d,b,k)}else eo(d,b)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var p=void 0===p?"":p;var n=void 0===n?window:n;c=n.location;a=ec(a,l)+p;a=a instanceof Fb?a:Lb(a);c.href=Hb(a)}return!0}
;z("yt.setConfig",N,void 0);z("yt.config.set",N,void 0);z("yt.setMsg",vf,void 0);z("yt.msgs.set",vf,void 0);z("yt.logging.errors.log",Mk,void 0);
z("writeEmbed",function(){var a=E("PLAYER_CONFIG",void 0);if(!a){var b=E("PLAYER_VARS",void 0);b&&(a={args:b})}cl(!0);"gvn"===a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=E("POST_MESSAGE_ORIGIN");window!==window.top&&c&&c!==document.URL&&(a.args.loaderUrl=c);E("EXPERIMENT_FLAGS").embeds_js_api_set_1p_cookie&&(c=gg(),c.embedsTokenValue&&(a.args.embedsTokenValue=c.embedsTokenValue));N("FORCE_CSI_ON_GEL",
!0);c=["ol"];Zl("").info.actionType="embed";c&&N("TIMING_AFT_KEYS",c);N("TIMING_ACTION","embed");c=E("TIMING_INFO",{});for(var d in c)c.hasOwnProperty(d)&&om(d,c[d]);om("is_nav",1);(d=pl())&&om("csn",d);(d=E("PREVIOUS_ACTION",void 0))&&!jm()&&om("pa",d);d=Ul();c=E("CLIENT_PROTOCOL");var e=E("CLIENT_TRANSPORT");c&&om("p",c);e&&om("t",e);om("yt_vis",tm());om("yt_lt","cold");c=Ql();if(e=Sl())Z("srt",c.responseStart),1!==d.prerender&&(om("yt_sts","n",void 0),Z("_start",e,void 0));d=Xl();0<d&&Z("fpt",
d);if(!O("log_deltas_killswitch")){var f,g,h,k;W&&W.timing&&(W.timeOrigin&&W.timing.navigationStart&&qm("startTimeDelta",Math.floor(W.timeOrigin)-W.timing.navigationStart),(d=null===(k=null===(h=null===(g=null===(f=W.getEntriesByType)||void 0===f?void 0:f.call(W,"navigation"))||void 0===g?void 0:g[0])||void 0===h?void 0:h.toJSON)||void 0===k?void 0:k.call(h))&&d.responseEnd&&W.timing.responseEnd&&qm("responseEndDelta",Rl(d.responseEnd)-W.timing.responseEnd))}f=Ql();f.isPerformanceNavigationTiming&&
om("pnt",1,void 0);Z("nreqs",f.requestStart,void 0);Z("nress",f.responseStart,void 0);Z("nrese",f.responseEnd,void 0);0<f.redirectEnd-f.redirectStart&&(Z("nrs",f.redirectStart,void 0),Z("nre",f.redirectEnd,void 0));0<f.domainLookupEnd-f.domainLookupStart&&(Z("ndnss",f.domainLookupStart,void 0),Z("ndnse",f.domainLookupEnd,void 0));0<f.connectEnd-f.connectStart&&(Z("ntcps",f.connectStart,void 0),Z("ntcpe",f.connectEnd,void 0));f.secureConnectionStart>=Sl()&&0<f.connectEnd-f.secureConnectionStart&&(Z("nstcps",
f.secureConnectionStart,void 0),Z("ntcpe",f.connectEnd,void 0));W&&W.getEntriesByType&&vm();f=[];if(document.querySelector&&W&&W.getEntriesByName)for(var l in Nl)Nl.hasOwnProperty(l)&&(g=Nl[l],um(l,g)&&f.push(g));f.length&&om("rc",f.join(","));if(jm(void 0)){l={actionType:dm[E("TIMING_ACTION",void 0)]||"LATENCY_ACTION_UNKNOWN",previousAction:dm[E("PREVIOUS_ACTION",void 0)]||"LATENCY_ACTION_UNKNOWN"};if(f=pl())l.clientScreenNonce=f;f=Vl(void 0);bm().info(l,f)}l=Ul();g=Pl();if("cold"===l.yt_lt&&(f=
lm(),h=f.gelTicks?f.gelTicks:f.gelTicks={},f=f.gelInfos?f.gelInfos:f.gelInfos={},jm())){for(var p in g)"tick_"+p in h||km(p,g[p]);p=nm();g=Vl();h={};for(var n in l)"info_"+n in f||!(k=mm(n,l[n]))||(Bl(p,k),Bl(h,k));bm().info(h,g)}z("ytglobal.timingready_",!0,void 0);pm();(n=E("WEB_PLAYER_CONTEXT_CONFIGS",void 0))&&"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in n?(n=n.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER,n.serializedForcedExperimentIds||(p=gg(),p.forced_experiments&&(n.serializedForcedExperimentIds=
p.forced_experiments)),Zn=Xn(a,n,!1)):Zn=Xn(a);Zn.addEventListener("onVideoDataChange",bo);a=E("POST_MESSAGE_ID","player");E("ENABLE_JS_API")?ao=new nn(Zn):E("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&($n=new un(window.parent,a,b),ao=new rn(Zn,$n.connection));Rm();E("EXPERIMENT_FLAGS").networkless_logging_web_embedded&&ck();E("EXPERIMENT_FLAGS").embeds_enable_ua_ch_polyfill&&en()},void 0);
var go=rf(function(){rm();var a=uh.getInstance(),b=!!((xh("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&Jd(document.body,"exp-invert-logo"))if(c&&!Jd(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!Jd(d,"inverted-hdpi")){var e=Hd(d);Id(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&Jd(document.body,"inverted-hdpi")&&Kd();if(b!=c){b="f"+(Math.floor(119/31)+1);d=xh(b)||0;d=c?d|67108864:
d&-67108865;0==d?delete th[b]:(c=d.toString(16),th[b]=c.toString());c=!0;O("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.h;d=[];for(var f in th)d.push(f+"="+encodeURIComponent(String(th[f])));sh(b,d.join("&"),63072E3,a.i,c)}xm.h||(xm.h=new xm);a=xm.h;f=16623;var g=void 0===g?{}:g;Object.values(Ok).includes(f)||(Lk(new ei("createClientScreen() called with a non-page VE",f)),f=83769);g.isHistoryNavigation||a.h.push({rootVe:f,key:g.key||""});a.l=[];a.u=[];g.Da?Am(a,f,g):Bm(a,f,g)}),ho=rf(function(){Zn&&
Zn.sendAbandonmentPing&&Zn.sendAbandonmentPing();
E("PL_ATT")&&Xm.dispose();for(var a=0,b=Pm.length;a<b;a++)Rf(Pm[a]);Pm.length=0;Nm("//static.doubleclick.net/instream/ad_status.js");Qm=!1;N("DCLKSTAT",0);Fd(ao,$n);Zn&&(Zn.removeEventListener("onVideoDataChange",bo),Zn.destroy())});
window.addEventListener?(window.addEventListener("load",go),window.addEventListener("unload",ho)):window.attachEvent&&(window.attachEvent("onload",go),window.attachEvent("onunload",ho));Qa("yt.abuse.player.botguardInitialized",A("yt.abuse.player.botguardInitialized")||Ym);Qa("yt.abuse.player.invokeBotguard",A("yt.abuse.player.invokeBotguard")||Zm);Qa("yt.abuse.dclkstatus.checkDclkStatus",A("yt.abuse.dclkstatus.checkDclkStatus")||Sm);
Qa("yt.player.exports.navigate",A("yt.player.exports.navigate")||fo);Qa("yt.util.activity.init",A("yt.util.activity.init")||Tf);Qa("yt.util.activity.getTimeSinceActive",A("yt.util.activity.getTimeSinceActive")||Wf);Qa("yt.util.activity.setTimestamp",A("yt.util.activity.setTimestamp")||Uf);}).call(this);
